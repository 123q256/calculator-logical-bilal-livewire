...
class SystemOfEquationsCalculator extends Component
{
   public $error = null;
    public $detail = null;
    ...
    public $a2_s = '5', $b2_s = '6', $c2_s = '7', $k2_s = '12';
    public $a3_s = '15', $b3_s = '17', $c3_s = '25', $k3_s = '2';
  ...
  public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->k2_s = $inputs['k2_s'] ?? '12';
            $this->a3_s = $inputs['a3_s'] ?? '15';
            $this->b3_s = $inputs['b3_s'] ?? '17';
            $this->c3_s = $inputs['c3_s'] ?? '25';
            $this->k3_s = $inputs['k3_s'] ?? '2';
        }
    }
  ...
  public function resetForm()
    {
        ...
        $this->a2_s = '5'; $this->b2_s = '6'; $this->c2_s = '7'; $this->k2_s = '12';
        $this->a3_s = '15'; $this->b3_s = '17'; $this->c3_s = '25'; $this->k3_s = '2';
   ...
   public function render()
    {
        ...
        return view('livewire.calculators.system-of-equations-calculator');
    }
}
