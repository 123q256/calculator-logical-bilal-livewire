...
class EvenOddFunctionCalculator extends Component
{
    public $EnterEq = '3x^2 - 1';
    public $with = 'x';
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.even-odd-function-calculator');
    }
}
