...
class SnellsLawCalculator extends Component
{
    ...
    {
        if ($propertyName === 'medium1') {
            $values = [
                'vacuum' => '1', 'air' => '1.000293', 'water' => '1.333', 'ethanol' => '1.36',
                'ice' => '1.31', 'acrylic' => '1.49', 'window' => '1.52', 'diamond' => '2.419'
            ];
            if (isset($values[$this->medium1])) {
                $this->n1 = $values[$this->medium1];
            }
        }

        if ($propertyName === 'medium2') {
            $values = [
                'vacuum' => '1', 'air' => '1.000293', 'water' => '1.333', 'ethanol' => '1.36',
                'ice' => '1.31', 'acrylic' => '1.49', 'window' => '1.52', 'diamond' => '2.419'
            ];
            if (isset($values[$this->medium2])) {
                $this->n2 = $values[$this->medium2];
            }
        }
    ...
    public function calculate()
    {
        $request = (object)[
            ...
            'n2'           => $this->n2,
            'angle_first'  => $this->angle_first,
            'angle_f_unit' => $this->angle_f_unit,
            'angle_second' => $this->angle_second,
            'angle_s_unit' => $this->angle_s_unit,
        ];

        $model = new Physics();
        $result = $model->snells($request);
   ...
   public function render()
    {
        ...
        return view('livewire.calculators.snells-law-calculator');
    }
}
