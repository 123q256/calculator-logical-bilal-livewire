...
class SodCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['error', 'detail', 'method', 'length', 'length_unit', 'width', 'width_unit', 'area', 'area_unit', 'price']);
        $this->resetErrorBag();
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.sod-calculator');
    }
}
