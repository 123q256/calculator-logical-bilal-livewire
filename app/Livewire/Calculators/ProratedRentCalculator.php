...
class ProratedRentCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['date', 'rent', 'bill_on', 'detail', 'error']);
        $this->date = date('Y-m-d');
    ...
    public function calculate()
    {
        ...
        $result = $model->prorated((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.prorated-rent-calculator');
    }
}
