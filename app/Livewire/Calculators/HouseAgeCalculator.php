...
class HouseAgeCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    public $build_date = '';
    public $structure_type = 'concrete';
    ...
    {
        $this->reset(['build_date', 'structure_type', 'detail', 'error']);
    ...
    public function calculate()
    {
        ...
        $result = $model->house((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.house-age-calculator');
    }
}
