...
class SpecificGravityCalculator extends Component
{
    public $t_fluid = 'ls';
    public $density = 12;
    ...
    public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->t_fluid = $inputs->t_fluid ?? 'ls';
            $this->density = $inputs->density ?? 12;
   ...
   public function render()
    {
        ...
        return view('livewire.calculators.specific-gravity-calculator');
    }
}
