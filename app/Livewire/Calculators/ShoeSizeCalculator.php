...
class ShoeSizeCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['gen', 'country', 'size', 'detail', 'error']);
    ...
    public function calculate()
    {
        ...
        $result = $model->shoe((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.shoe-size-calculator');
    }
}
