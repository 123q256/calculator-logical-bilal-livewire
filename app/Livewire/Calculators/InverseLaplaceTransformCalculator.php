...
class InverseLaplaceTransformCalculator extends Component
{
    public $EnterEq = '4/(s-3) - 1/(s-8)';
    ...
    public function calculate()
    {
        ...
        $model = new Math();
        $result = $model->inverse_lap($request);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.inverse-laplace-transform-calculator');
    }
}
