...
class RemainderTheoremCalculator extends Component
{
    public $num = '2x^2-5x-1';
    public $denom = 'x-5';
    ...
    public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->num = $inputs['num'] ?? $this->num;
            $this->denom = $inputs['denom'] ?? $this->denom;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.remainder-theorem-calculator');
    }
}
