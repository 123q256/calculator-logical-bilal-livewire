...
class FortyfiveFortyfiveNinetyCalculator extends Component
{
  public $error = null;
    public $detail = null;
  ...
  public function updated()
    ...
    public function calculate()
    {
        ...
        $model = new Math();
        $result = $model->forty_five($request);
   ...
   public function render()
    {
        ...
        return view('livewire.calculators.fortyfive-fortyfive-ninety-calculator');
    }
}
