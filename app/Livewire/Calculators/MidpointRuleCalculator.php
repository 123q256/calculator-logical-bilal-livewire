...
class MidpointRuleCalculator extends Component
{
    ...
    public function calculate()
    {
        ...
        if ($this->lb >= $this->ub) {
            $this->error = 'The lower limit should be less than the upper limit.';
            session()->flash('validation_error', $this->error);
            $this->detail = null;
            return;
        }
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.midpoint-rule-calculator');
    }
}
