...
class CtrCalculator extends Component
{
    ...
    public function mount($type = 'calculator', $lang = [], $currancy = '$')
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->impression = $inputs->impression ?? 5000;
            $this->clicks = $inputs->clicks ?? 50;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.ctr-calculator');
    }
}
