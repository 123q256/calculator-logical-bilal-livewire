...
class RmrCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->unit_h = $inputs->unit_h ?? $this->unit_h;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.rmr-calculator');
    }
}
