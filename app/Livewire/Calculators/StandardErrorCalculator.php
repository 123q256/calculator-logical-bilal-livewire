...
class StandardErrorCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    public function calculate()
    {
        ...
        $result = $model->standerror($request);
   ...
   public function render()
    {
        ...
        return view('livewire.calculators.standard-error-calculator');
    }
}
