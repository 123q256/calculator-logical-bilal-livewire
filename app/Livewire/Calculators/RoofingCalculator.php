...
class RoofingCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    public $length = '4';
    public $length_units = 'cm';
    public $width = '8';
    public $width_units = 'cm';
    public $pitch = '6';
    public $price = '5';
    public $price_units = 'mm²';
    ...
    {
        $this->reset(['error', 'detail', 'length', 'length_units', 'width', 'width_units', 'pitch', 'price', 'price_units']);
        $this->resetErrorBag();
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.roofing-calculator');
    }
}
