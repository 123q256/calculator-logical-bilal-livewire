...
class UtGpaCalculator extends Component
{
    public $currentGpa = '';
    ...
    {
        $this->semesters[$sIndex]['courses'][] = ['subject' => '', 'grade' => '', 'credit' => '3'];
        $this->detail = null;
    }
    ...
    public function calculate()
    {
        ...
        if ($totalCredits > 0) {
            ...
            $color = '#B71919';
            if ($cgpa >= 3.5) $color = '#13699E';
            elseif ($cgpa >= 3.0) $color = '#54B725';
    ...
    {
        return view('livewire.calculators.ut-gpa-calculator');
    }
}
