...
class TripleIntegralCalculator extends Component
{
    ...
    public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->lbz     = $inputs['lbz']     ?? $this->lbz;
            $this->ubz     = $inputs['ubz']     ?? $this->ubz;
        }
    }
    ...
    public function resetForm()
    {
        ...
        $this->with    = 'xyz';
        $this->form    = 'indef';
        $this->lbx = $this->ubx = $this->lby = $this->uby = $this->lbz = $this->ubz = '';
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.triple-integral-calculator');
    }
}
