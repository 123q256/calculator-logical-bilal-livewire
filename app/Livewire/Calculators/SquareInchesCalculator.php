...
class SquareInchesCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['error', 'detail', 'length', 'l_units', 'width', 'w_units', 'price']);
        $this->resetErrorBag();
    ...
    public function calculate()
    {
        ...
        $request = (object)[
            ...
            'price' => $this->price,
            'volume_select' => 1, // Rectangle
        ];

        $model = new Construction();
        $result = $model->square_inches($request);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.square-inches-calculator');
    }
}
