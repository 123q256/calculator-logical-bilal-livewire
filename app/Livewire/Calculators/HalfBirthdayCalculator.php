...
class HalfBirthdayCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['year', 'month', 'day', 'detail', 'error']);
    ...
    public function calculate()
    {
        ...
        $result = $model->half((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.half-birthday-calculator');
    }
}
