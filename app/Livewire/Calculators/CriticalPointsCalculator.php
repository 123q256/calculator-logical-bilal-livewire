...
class CriticalPointsCalculator extends Component
{
    public $EnterEq = '4x^2 + 8xy +2y';
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.critical-points-calculator');
    }
}
