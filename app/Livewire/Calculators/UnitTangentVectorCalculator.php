...
class UnitTangentVectorCalculator extends Component
{
    public $x = 'sin(t)';
    public $y = 'cos(t)';
    public $z = 'tan(t)';
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.unit-tangent-vector-calculator');
    }
}
