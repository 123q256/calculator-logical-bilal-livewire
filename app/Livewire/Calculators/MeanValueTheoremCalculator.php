...
class MeanValueTheoremCalculator extends Component
{
    ...
    public function calculate()
    {
        ...
        $request = new class($inputs) {
            private $inputs;
            public function __construct($inputs) { $this->inputs = $inputs; }
            public function all() { return $this->inputs; }
            public function __get($name) { return $this->inputs[$name] ?? null; }
        };
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.mean-value-theorem-calculator');
    }
}
