...
class PercentileCalculator extends Component
{
    public $seprateby = 'space';
    public $seprate = ' ';
    public $x = '55 62 35 32 50 57 54';
    public $p = '16';
    public $advancedcheck = false;
    ...
    public function mount($type = 'calculator', $lang = [])
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->p = $inputs->p ?? '16';
            $this->advancedcheck = $inputs->advancedcheck ?? false;
        }
    }
    ...
    public function calculate()
    {
        $request = (object)[
            ...
            'x' => $this->x,
            'p' => $this->p,
            'advancedcheck' => $this->advancedcheck ? 'true' : 'false',
        ];

        $model = new Statistics();
        $result = $model->percentile($request);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.percentile-calculator');
    }
}
