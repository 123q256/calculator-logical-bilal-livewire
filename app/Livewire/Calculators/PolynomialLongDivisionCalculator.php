...
class PolynomialLongDivisionCalculator extends Component
{
    public $dividend = '2x^3 - 3x^2 + 13x - 5';
    public $divisor = 'x + 5';
    ...
    public function mount($type = 'calculator', $lang = [], $device = 'desktop')
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->dividend = $inputs['dividend'] ?? '2x^3 - 3x^2 + 13x - 5';
            $this->divisor = $inputs['divisor'] ?? 'x + 5';
        }
    }
    ...
    public function calculate()
    {
        ...
        $model = new Math();
        $result = $model->polynomial(request());
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.polynomial-long-division-calculator');
    }
}
