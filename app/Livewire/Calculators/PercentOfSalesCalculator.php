...
class PercentOfSalesCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    public function mount($type = 'calculator', $lang = [], $currancy = '$')
    {
        ...
        if (session()->has('calculator_back_inputs')) {
            ...
            $this->item = $inputs->item ?? 2000;
            $this->sale = $inputs->sale ?? 50;
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.percent-of-sales-calculator');
    }
}
