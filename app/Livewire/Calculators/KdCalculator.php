...
class KdCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['kills', 'deaths', 'assists', 'detail', 'error']);
    ...
    public function calculate()
    {
        ...
        $result = $model->kd((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.kd-calculator');
    }
}
