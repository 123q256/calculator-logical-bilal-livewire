...
class McgToMgCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['operations', 'first', 'detail', 'error']);
    ...
    public function calculate()
    {
        ...
        $result = $model->mcg((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.mcg-to-mg-calculator');
    }
}
