...
class BirthdayCalculator extends Component
{
    public $error = null;
    public $detail = null;
    ...
    {
        $this->reset(['next_birth', 'detail', 'error']);
    ...
    {
        $requestData = [
            'next_birth' => $this->next_birth,
        ];

        $model = new EverydayLife();
        $result = $model->birthday((object)$requestData);
    ...
    public function render()
    {
        ...
        return view('livewire.calculators.birthday-calculator');
    }
}
