                ...
                <div class="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                    <div class="col-span-12">
                        ...
                        <div class="w-full py-2">
                            <input type="number" step="any" wire:model.live="arctan" id="arctan" class="input" aria-label="input" />
                        </div>
                    </div>
                    <div class="col-span-12">
                    ...
                    <div class="w-full mt-3">
                        <div class="w-full">
                            ...
                            <div class="w-full md:w-[60%] lg:w-[60%] mt-3 overflow-x-auto">
                                <table class="w-full text-[18px]">
                                    @foreach([['gon', 'gradians'], ['tr', 'turns'], ['arcmin', 'minutes of'], ['arcsec', 'seconds of'], ['mrad', 'miliradians'], ['urad', 'microradians'], ['pirad', 'π radians']] as $unit)
                                        <tr>
                                            <td class="py-2 border-b whitespace-nowrap" width="40%">arctan ({{ $arctan }})</td>
                            ...
                            <div class="w-full text-[16px] mt-3 overflow-x-auto">
                                ...
                                <p class="mt-2 text-[18px] whitespace-nowrap">arctan {{ $arctan }} = tan<sup class="font-s-14">-1</sup> {{ $arctan }} = {{ $detail['deg'] }}° {{ $detail['min'] }}' {{ $detail['sec'] }}"</p>
                                <p class="mt-2 text-[18px] whitespace-nowrap">= {{ $detail['angle'] }} + k * 180° (k = -1,0,1,...)</p>
                                ...
                                <p class="mt-2 text-[18px] whitespace-nowrap">= {{ $detail['rad'] }} rad + k * π (k = -1,0,1,...)</p>
                                <p class="mt-2 text-[18px] whitespace-nowrap">= 
                                    @php
