<div>
 <form wire:submit.prevent="calculate">
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       @endif
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto " x-data="{ ops: @entangle('operations') }">
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-12" wire:ignore>
                    <p x-show="ops == 1" class="text-center mt-2 text-[14px]" id="math_1">
                        \( 
                            \begin{cases}
                                \text{$a_1x + b_1y = k_1$}\\
                                \text{$a_2x + b_2y = k_2$}\\
                    ...
                    <p x-show="ops == 2" class="text-center mt-2 text-[14px]" id="math_2" style="display: none;">
                        \( 
                            \begin{cases}
                ...
                <div class="col-span-12 twoInput" x-show="ops == 1">
                ...
                <div class="col-span-12 threeInput" x-show="ops == 2" style="display: none;">
                    <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div class="w-full">
                        @if($operations==1)
                            ...
                            @if($method==1)
                                ...
                                <p class="mt-3">Apply Gauss-Jordan Elimination method: (<?=$lang[9]?> <a href="{{ url('gaussian-elimination-calculator') }}/" class="text-blue-500 underline" target="_blank">Gaussian Elimination Calculator</a>)</p>
                                <p class="mt-3">\( \left[
                            ...
                            @elseif($method==2)
                                ...
                                <p class="mt-3"><?=$lang[13]?>: \( \begin{bmatrix}<?=((!empty($a1_f)?$a1_f:0))?> & <?=((!empty($b1_f)?$b1_f:0))?>\\<?=((!empty($a2_f)?$a2_f:0))?> & <?=((!empty($b2_f)?$b2_f:0))?>\\\end{bmatrix}^1 = \begin{bmatrix}<?=round($detail['inv'][0][0],4)?> & <?=round($detail['inv'][0][1],4)?>\\<?=round($detail['inv'][1][0],4)?> & <?=round($detail['inv'][1][1],4)?>\\\end{bmatrix}\) (<?=$lang[9]?> <a href="{{ url('inverse-matrix-calculator') }}/" class="text-blue-500 underline" target="_blank">Inverse Matrix Calculator</a>)</p>
                                <p class="mt-3"><?=$lang[12]?>: \( \begin{bmatrix}x\\y\\\end{bmatrix} = \begin{bmatrix}<?=round($detail['inv'][0][0],4)?> & <?=round($detail['inv'][0][1],4)?>\\<?=round($detail['inv'][1][0],4)?> & <?=round($detail['inv'][1][1],4)?>\\\end{bmatrix} \begin{bmatrix}<?=$k1_f?>\\<?=$k2_f?>\\\end{bmatrix} = \begin{bmatrix}<?=$detail['x']?>\\<?=$detail['y']?>\\\end{bmatrix}\) (<?=$lang[9]?> <a href="{{ url('matrix-multiplication-calculator') }}/" class="text-blue-500 underline" target="_blank">Matrix Multiplication Calculator</a>)</p>
                            @elseif($method==3)
                                ...
                                <p class="mt-3"><?=$lang[10]?> (<?=$lang[9]?> <a href="{{ url('determinant-calculator') }}/" class="text-blue-500 underline" target="_blank">Determinant Calculator</a>)\( D = \begin{vmatrix}<?=((!empty($a1_f)?$a1_f:0))?> & <?=((!empty($b1_f)?$b1_f:0))?> \\<?=((!empty($a2_f)?$a2_f:0))?> & <?=((!empty($b2_f)?$b2_f:0))?>\\\end{vmatrix} = <?=$detail['det1']?>\)</p>
                        ...
                        @else
                            ...
                            @if($method==1)
                                ...
                                <p class="mt-3">Apply Gauss-Jordan Elimination method: (<?=$lang[9]?> <a href="{{ url('gaussian-elimination-calculator') }}/" class="text-blue-500 underline" target="_blank">Gaussian Elimination Calculator</a>)\( \left[
                            ...
                            @elseif($method==2)
                                ...
                                <p class="mt-3"><?=$lang[13]?>: \( \begin{bmatrix}<?=((!empty($a1_s)?$a1_s:0))?> & <?=((!empty($b1_s)?$b1_s:0))?> & <?=((!empty($c1_s)?$c1_s:0))?>\\<?=((!empty($a2_s)?$a2_s:0))?> & <?=((!empty($b2_s)?$b2_s:0))?> & <?=((!empty($c2_s)?$c2_s:0))?>\\<?=((!empty($a3_s)?$a3_s:0))?> & <?=((!empty($b3_s)?$b3_s:0))?> & <?=((!empty($c3_s)?$c3_s:0))?>\\\end{bmatrix} ^1 = \begin{bmatrix}<?=round($detail['inv'][0][0],4)?> & <?=round($detail['inv'][0][1],4)?> & <?=round($detail['inv'][0][2],4)?>\\<?=round($detail['inv'][1][0],4)?> & <?=round($detail['inv'][1][1],4)?> & <?=round($detail['inv'][1][2],4)?>\\<?=round($detail['inv'][2][0],4)?> & <?=round($detail['inv'][2][1],4)?> & <?=round($detail['inv'][2][2],4)?>\\\end{bmatrix}\) (<?=$lang[9]?> <a href="{{ url('inverse-matrix-calculator') }}/" class="text-blue-500 underline" target="_blank">Inverse Matrix Calculator</a>)</p>
                                <p class="mt-3"><?=$lang[12]?>: \( \begin{bmatrix}x\\y\\z\\\end{bmatrix} = \begin{bmatrix}<?=round($detail['inv'][0][0],4)?> & <?=round($detail['inv'][0][1],4)?> & <?=round($detail['inv'][0][2],4)?>\\<?=round($detail['inv'][1][0],4)?> & <?=round($detail['inv'][1][1],4)?> & <?=round($detail['inv'][1][2],4)?>\\<?=round($detail['inv'][2][0],4)?> & <?=round($detail['inv'][2][1],4)?> & <?=round($detail['inv'][2][2],4)?>\\\end{bmatrix} \begin{bmatrix}<?=((!empty($k1_s)?$b3_s:0))?>\\<?=((!empty($k2_s)?$k2_s:0))?>\\<?=((!empty($k3_s)?$k3_s:0))?>\\\end{bmatrix} = \begin{bmatrix}<?=$detail['x']?>\\<?=$detail['y']?>\\<?=$detail['z']?>\\\end{bmatrix}\) (<?=$lang[9]?> <a href="{{ url('matrix-multiplication-calculator') }}/" class="text-blue-500 underline" target="_blank">Matrix Multiplication Calculator</a>)</p>
                            @elseif($method==3)
