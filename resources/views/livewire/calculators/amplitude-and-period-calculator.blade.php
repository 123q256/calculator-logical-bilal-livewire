            ...
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-12">
                    ...
                    <div class="w-full py-2">
                        <select class="input" aria-label="select" name="trigonometric_unit" id="trigonometric_unit" wire:model.live="trigonometric_unit">
                ...
                <div class="col-span-6">
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" name="first_number" id="first_number" class="input"
                            wire:model.live="first_number" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-6">
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" name="second_number" id="second_number" class="input"
                            wire:model.live="second_number" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-6">
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" name="third_number" id="third_number" class="input"
                            wire:model.live="third_number" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-6">
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" name="fourth_number" id="fourth_number" class="input"
                            wire:model.live="fourth_number" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-6">
                    ...
                    <div class="w-full py-2 relative">
                        <input type="number" step="any" name="x_not" id="x_not" class="input"
                            wire:model.live="x_not" aria-label="input" />
        ...
        <div class="">
            ...
            <div class="rounded-lg  flex items-center justify-center">
                <div class="w-full mt-3">
                    <div class="w-full">
                        @php
                            if (!function_exists('change_coefficient')) {
                            ...
                            if (!function_exists('changeFunction')) {
                            ...
                            if(!empty($x_not)){
                                if ($detail['operation'] == '1' && $detail['sixth_number'] > 0) {
                                    $first_section =
                                        sin($detail['fifth_number'] * $x_not) * cos($detail['sixth_number']) -
                                        cos($detail['fifth_number'] * $x_not) * sin($detail['sixth_number']);
                                    ...
                                    $first_section =
                                        cos($detail['fifth_number'] * $x_not) * cos($detail['sixth_number']) +
                                        sin($detail['fifth_number'] * $x_not) * sin($detail['sixth_number']);
                                    $final_section = $detail['first_number'] * $first_section + $detail['fourth_number'];
                                } elseif ($detail['operation'] == '2' && $detail['sixth_number'] > 0) {
                                    $first_section =
                                        cos($detail['fifth_number'] * $x_not) * cos($detail['sixth_number']) -
                        ...
                        <div class="w-full lg:w-[80%] overflow-auto  mt-2">
                            <table class="w-full text-[18px]">
                                @if(!empty($x_not))
                                    <tr>
                                        <td class="py-2 border-b"><strong>f(x₀)</strong></td>
