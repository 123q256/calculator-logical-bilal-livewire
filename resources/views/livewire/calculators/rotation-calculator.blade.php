       ...
       <div class="lg:w-[50%] md:w-[50%] w-full mx-auto ">
            ...
            <div class="col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" id="point_rotate_one" class="input" aria-label="input" wire:model.live="point_rotate_one" />
                </div>
            </div>
            <div class="col-span-6">
                <label for="point_rotate_two" class="font-s-14 text-blue">&nbsp;</label>
                <div class="w-full py-2">
                    <input type="number" step="any" id="point_rotate_two" class="input" aria-label="input" wire:model.live="point_rotate_two" />
                </div>
            </div>
            <div class="col-span-6">
                <label for="angle" class="font-s-14 text-blue"><?=$lang['2'] ?></label>
                <div class="w-full py-2">
                    <input type="number" step="any" id="angle" class="input" aria-label="input" wire:model.live="angle" />
                </div>
            </div>
            <div class="col-span-6">
                ...
                <div class="w-full py-2">
                    <select wire:model.live="unit" class="input" id="unit" aria-label="select">
                        ...
                        <option value="degrees">{{$lang['6']}}</option>
                    </select>
                </div>
            </div>
            <div class="col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" id="point_around_one" class="input" aria-label="input" wire:model.live="point_around_one" />
                </div>
            </div>
            <div class="col-span-6">
                <label for="point_around_two" class="font-s-14 text-blue">&nbsp;</label>
                <div class="w-full py-2">
                    <input type="number" step="any" id="point_around_two" class="input" aria-label="input" wire:model.live="point_around_two" />
                </div>
            </div>
            <div class="col-span-12">
                <label for="direction" class="font-s-14 text-blue"><?=$lang['5'] ?></label>
                <div class="w-full py-2">
                    <select wire:model.live="direction" class="input" id="direction" aria-label="select">
                        <option value="anticlockwise">{{$lang['9']}}</option>
                        <option value="clockwise">{{$lang['8']}}</option>
                    </select>
                </div>
            </div>
        </div>
