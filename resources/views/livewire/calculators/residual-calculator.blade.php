                    ...
                    <div class="rounded-lg flex items-center justify-center">
                        <div class="w-full mt-3">
                            <div class="w-full">
                                ...
                                <p class="w-full font-s-18"><strong class="text-blue">{{ $lang['satement1'] }}:</strong></p>
                                ...
                                <p class="w-full mt-4 font-s-18"><strong class="text-blue">{{ $lang['satement2'] }}:</strong></p>
                                <div class="w-full mt-2 overflow-auto">
                                    <table class="w-full" style="border-collapse: collapse">
                                        <tr class="bg-gray-100">
                                            <td class="p-2 border text-center"><strong class="text-blue">Obs.</strong></td>
                                ...
                                <div class="p-2 mt-2">
                                    ...
                                    <p class="w-full mt-3 mb-4">{{ $lang['satement7'] }}:</p>
                                    ...
                                    <div class="w-full mt-4" x-data="{
                                        initChart() {
                                            if(window.myResidualChart) {
                                                window.myResidualChart.destroy();
                                            }
                                            ...
                                            const xyValues = [
                                                @foreach($y_bar as $key => $value)
                                                    {x: {{ $value }}, y: {{ $yy_bar[$key] }} },
                                                @endforeach
                                            ];

                                            window.myResidualChart = new Chart(ctx, {
                                                type: 'scatter',
                                                data: {
                                                    datasets: [{
                                                        pointRadius: 4,
