                        ...
                        <div class="w-full mt-3">
                            <div class="w-full">
                                    ...
                                    <table class="w-full text-[18px]">
                                        <tr>
                                            ...
                                            <td class="py-2 border-b">
                                                {{ !empty($detail['poutlier']) ? implode(', ', $detail['poutlier']) : 'None' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="py-2 border-b"><strong>{{ $lang['4'] }} (s)</strong></td>
                                            <td class="py-2 border-b">
                                                {{ !empty($detail['outlier']) ? implode(', ', $detail['outlier']) : 'None' }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <p class="w-full mt-2">{{ $lang[9] }}: 
                                    <strong>{{ implode(', ', $detail['values']) }}</strong></p>
                                <p class="w-full mt-2">{{ $lang[10] }}, IQR</p>
                                <p class="w-full mt-2">$$IQR = Q_3 - Q_1$$</p>
                                ...
                                <p class="w-full mt-2">$$Q_1 - (1.5 \times IQR) \text{ {{ $lang[12] }} } Q_3 + (1.5 \times IQR)$$</p>
                                ...
                                <p class="w-full mt-2">$$Q_1 - (3 \times IQR) \text{ {{ $lang[12] }} } Q_3 + (3 \times IQR)$$</p>
