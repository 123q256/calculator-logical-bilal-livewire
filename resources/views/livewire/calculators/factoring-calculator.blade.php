           ...
           <div class="col-12 col-lg-9 mx-auto mt-2  w-full">
            <div class="flex flex-wrap items-center bg-blue-100 border border-blue-500 text-center rounded-lg px-1">
                <div class="lg:w-1/2 w-full px-2 py-1">
                    <div class="bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300  hover_tags hover:text-white  tab {{ $calc_type === 'factoring' ? 'tagsUnit':'' }}" wire:click="$set('calc_type', 'factoring')">
                            {{ $lang['12'] }}
                    </div>
                </div>
                <div class="lg:w-1/2 w-full px-2 py-1">
                    <div class="bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300  hover_tags hover:text-white tab {{ $calc_type === 'factor' ? 'tagsUnit':'' }}" wire:click="$set('calc_type', 'factor')">
                            {{ $lang['11'] }}
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                @if($calc_type === 'factoring')
                <div class="col-span-12 factoringInput">
                ...
                @else
                <div class="col-span-12 factorInput">
                    <label for="num1" class="text-[14px] text-blue">{{$lang[1]}}:</label>
                    <div class="w-100 py-2">
                        <input type="number" max="10000000" name="num1" id="num1" class="input" wire:model.live="num1" aria-label="input"/>
                    </div>
                </div>
                <div class="col-span-12 factorInput">
                    <label for="num2" class="text-[14px] text-blue">{{$lang[2]}}:</label>
                    <div class="w-100 py-2">
                        <input type="number" max="10000000" name="num2" id="num2" class="input" wire:model.live="num2" aria-label="input"/>
                    </div>
                </div>
                @endif
        </div>
                        ...
                        @else
                            @if(is_numeric($num1))
                                <div class="w-full text-[16px]">
                                    <p class="mt-3 text-[18px]"><strong>{!! $lang["3"]." <span class='total_num1'></span> ".$lang["4"]." ".$num1 !!}</strong></p>
                            ...
                            @if(is_numeric($num2))
                                <div class="w-full text-[16px]">
                                    <p class="mt-3 text-[18px]"><strong>{!! $lang["3"]." <span class='total_num2'></span> ".$lang["4"]." ".$num2 !!}</strong></p>
                                    ...
                                    @if($num2 > 0)
                                        <p class="mt-3">{{$lang["5"]." ".$lang["4"]." ".$num2}}</p>
                                        <p class="mt-3">{{$detail["Factors2"]}}</p>
                                        <p class="mt-3">{{$lang["6"]." ".$lang["4"]." ".$num2}}</p>
                                        <p class="mt-3">
                                            @php
                                    ...
                                    @if(is_numeric($num1) && is_numeric($num2) && ($num1 > 0) && ($num2 > 0))
                                        <p class="mt-3">{!! $lang["3"]." <span class='comnFctr'></span> ".$lang["8"]." ".$num1." ".$lang["9"]." ".$num2." :" !!}</p>
                                    ...
                                    <div class="grid grid-cols-12 gap-3">
                                        @if($num1 > 0)
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                @if(is_numeric($num1))
                                                    <p class="mt-3 text-center">{{$lang["10"]." ".$num1}}</p>
                                        ...
                                        @if($num2 > 0)
                                            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                                @if(is_numeric($num2))
                                                    <p class="mt-3 text-center">{{$lang["10"]." ".$num2}}</p>
