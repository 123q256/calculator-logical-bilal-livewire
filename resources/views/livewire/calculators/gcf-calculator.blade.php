        ...
        <div class="lg:w-[50%] md:w-[50%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-full pt-2">
                    <textarea aria-label="textarea input" id="x" wire:model.live="x" name="x" class="textareaInput" placeholder="10, 20, 30" @click="$wire.set('detail', null)"></textarea>
                </div>
            </div>
            <div class="col-span-12">
                ...
                <div class="w-full pt-2">
                    <select name="method" wire:model.live="method" class="input" id="method" aria-label="select" @click="$wire.set('detail', null)">
                        ...
                        <option value="lm">{{$lang[5]}}</option>
                        <option value="Pf">{{$lang[6]}}</option>
                        <option value="ea">{{$lang[7]}}</option>
                        <option value="bs">{{$lang[8]}}</option>
                    </select>
                </div>
            </div>
        </div>
                            ...
                            @elseif($method =='lm')
                                <div class="col-span-12 md:col-span-6 lg:col-span-6 mt-2">
                                    <table class="w-full text-[18px]">
                                        <tr>
                                            <td class="py-2 border-b" width="60%"><strong>{{$lang['40']}} {{ $x }}</strong></td>
                                ...
                                <div class="w-full font-s-15">
                                    ...
                                    <p class="mt-2"><span class="text-blue">#3. </span> {{$lang['12']}}: {{ $x }}: {{$detail['gcf']}}</p>
                                </div>
                            @elseif($method =='Pf')
                                <div class="col-span-12 md:col-span-6 lg:col-span-6 mt-2">
                                    <table class="w-full text-[18px]">
                                ...
                                <div class="w-full font-s-15">
                                    ...
                                    <p class="mt-2"><span class="text-blue">#4. </span> {{$lang['17']}} ({{ $x }}) {{$lang['18']}}: {{$detail['gcf']}}</p>
                                </div>
                            @elseif($method =='ea')
                                <div class="col-span-12 md:col-span-6 lg:col-span-6 mt-2">
                                    <table class="w-full text-[18px]">
                                ...
                                <div class="w-full font-s-15">
                                    ...
                                    <p class="mt-2"><span class="text-blue">#6. </span> {{$lang['27']}}: ({{ $x }}) {{$lang['18']}}: {{$detail['gcf']}}</p>
                                </div>
                            @else
                                <div class="col-span-12 md:col-span-6 lg:col-span-6 mt-2">
                                    <table class="w-full text-[18px]">
                                ...
                                <div class="w-full font-s-15">
                                    ...
                                    @endphp
                                    <p class="mt-2">{{$lang['27']}} ({{ $x }}) {{$lang['18']}}: {{$detail['gcf']}}</p>
                                </div>
                            @endif
                        </div>
                    </div>
