                    ...
                    <div class="grid grid-cols-1  lg:grid-cols-1 md:grid-cols-1  gap-4">
                        ...
                        <div class="addweek1 row">
                            ...
                            <div class="row d-flex align-items-center row1">
                                <div class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7  gap-4">
                                    ...
                                    <div class="cspace-y-2 display_none pe-lg-2">
                                        <input type="number" min="0" max="2400" name="in[]"
                                            value="" placeholder="in" class="input fahad">
                                    </div>
                                    ...
                                    <div class="cspace-y-2 display_none ps-lg-2">
                                        <input type="number" min="0" max="2400" name="out[]"
                                            value="" placeholder="out" class="input fahad">
                                    </div>
                                </div>
                                <div
                                    class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7  gap-4  r1_lunch1 hidden">
                                    ...
                                    <div class="space-y-2 24h hidden pe-lg-2">
                                        <input type="number" min="0" max="2400" name="inlunch1[]"
                                            value="1" placeholder="_ _" class="input">
                                    </div>
                                ...
                                <div
                                    class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7  gap-4  r1_lunch2 hidden">
                                    <div class="space-y-2 "></div>
                            ...
                            <div class="row d-flex align-items-center row2 mt-2">
                                ...
                                <div
                                    class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7 r1_lunch1 hidden  gap-4">
                                    <div class="space-y-2 "></div>
                                    <div class="space-y-2 12h lunch1 ">
                                        <input type="number" name="inhourl1[]" value="1" placeholder="_ _"
                                            class="input">
                        ...
                        <div class="hidden addweek2 mt-2">
                            ...
                            <div class="row d-flex align-items-center row1">
                                ...
                                <div
                                    class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7  gap-4 r1_lunch1 hidden mt-2">
                                    <div class="space-y-2 "></div>
                                    <div class="space-y-2 12h lunch1 ">
                                ...
                                <div
                                    class="grid grid-cols-7 mt-4 lg:grid-cols- md:grid-cols-7  gap-4 r1_lunch2 hidden mt-2">
                                    <div class="space-y-2 "></div>
                                    <div class="space-y-2 12h lunch2">
                                    ...
                                    <div class="grid grid-cols-3  lg:grid-cols-3 md:grid-cols-3  gap-4">
                                        <div class="space-y-2 pe-2">
                                            ...
                                            <input type="number" name="paid_lunch1" value="8"
                                                min="0" max="59" placeholder="00" class="input ">
                                        </div>
                        ...
                        <div class="w-full my-2">
                            ...
                            @else
                                @if (isset(request()->cal_bus))
                                    ...
                                    @if (request()->method == '+')
                                        <p class="mb-2">{{ $lang['28'] }} {{ request()->days }}
