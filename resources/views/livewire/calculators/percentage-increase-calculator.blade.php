<div>
    <form wire:submit.prevent="calculate">
        ...
        @isset($detail)
            <hr>
            <div id="result-section" wire:loading.remove wire:target="calculate" class="w-full mx-auto p-4 lg:p-8 md:p-8 bg-white rounded-lg shadow-md space-y-6 result">
                <div>
                    @if ($type == 'calculator')
                        ...
                        <div class="w-full mt-3">
                            <div class="w-full">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="mt-3">{{ $lang['1'] }} = {{ $start }}<br></p>
                                    <p class="my-3">{{ $lang['2'] }} = {{ $final }} </p>
                                    <p>
                                        <span class="fraction">
                                    ...
                                    <p>
                                        <span class="fraction">
                                            <span class="num">{{ $final }} - {{ $start }}</span>
                                            <span class="visually-hidden"></span>
                                            <span class="den">|{{ $start }}|</span>
                                        </span> x 100
                                    </p>
                                    <p>
                                        <span class="fraction">
