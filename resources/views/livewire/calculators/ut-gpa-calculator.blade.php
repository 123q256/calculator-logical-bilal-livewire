<div>
    ...
    <form wire:submit.prevent="calculate">
        <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mt-3">
            ...
            <div class="lg:w-[90%] md:w-[90%] w-full mx-auto">
                <div class="grid grid-cols-12 gap-4">
                    <!-- Cumulative Section (Open by default) -->
                    ...
                    <div class="col-span-12">
                        <div class="border rounded-lg p-4 bg-white space-y-6">
                            <h3 class="text-xl font-bold border-b pb-2">UT Austin GPA Calculator</h3>
                                ...
                                @foreach($semesters as $sIndex => $semester)
                                    <div class="space-y-4" wire:key="semester-{{ $sIndex }}">
                                        ...
                                        <div class="grid grid-cols-12 gap-2 text-xs font-bold uppercase tracking-wider mb-2">
                                            <div class="col-span-5">{{ $lang['course'] }}</div>
                                            <div class="col-span-3">{{ $lang['credit'] }}</div>
        ...
        @isset($detail)
            <hr>
            <div id="result-section" wire:loading.remove wire:target="calculate" class="w-full mx-auto p-4 lg:p-8 md:p-8 space-y-10">
                <div class="">
                    @if ($type == 'calculator')
                    ...
                    <div class="flex flex-col items-center my-12">
                        <div class="knob-container gpa_knob scale-150">
                            <div class="inner_knob text-white" style="background-color: {{ $detail['color'] }}">
                                <p class="text-[10px] font-bold opacity-80 uppercase tracking-widest mb-1">{{ $lang['cum'] }}</p>
                                <p class="text-[25px] font-black">{{ $detail['cgpa'] }}</p>
                                <p class="text-[10px] font-bold opacity-80 uppercase tracking-widest mt-1">{{ $lang['10'] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto mt-16">
                        <div class="bg-white p-6 rounded-xl border border-blue-200 text-center">
                            <p class="text-blue-600 text-sm font-bold mb-2">{{ $lang['total_g'] }}</p>
                            <p class="text-4xl font-black text-blue-900">{{ $detail['totalGradePoints'] }}</p>
                        </div>
                        <div class="bg-white p-6 rounded-xl border border-blue-200 text-center">
                            <p class="text-blue-600 text-sm font-bold mb-2">{{ $lang['total_h'] }}</p>
                            <p class="text-4xl font-black text-blue-900">{{ $detail['totalCredits'] }}</p>
                        </div>
                    </div>

                    <div class="w-full mt-16 space-y-12">
                                    ...
                                    <table class="w-full text-base">
                                        ...
                                        <tfoot class="bg-gray-50/50 font-bold text-blue-800">
                                            <tr>
                                                ...
                                                <td colspan="1" class="p-2 border-b text-center text-blue-900 font-black text-lg">{{ $sRes['totalCredits'] }}</td>
                                            </tr>
                                            <tr class="border-t border-gray-200">
                                                <td colspan="3" class="p-2 border-b text-right font-black">Semester GPA</td>
                                                <td colspan="1" class="p-2 border-b text-center text-green-700 font-black text-2xl">{{ $sRes['gpa'] }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
