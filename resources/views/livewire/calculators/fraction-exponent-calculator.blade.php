            ...
            <div class="col-span-8">
                <div class="col-lg-10">
                    ...
                    <div class="col-12 mt-0 mt-lg-2">
                        ...
                        <div class="w-100 py-2">
                            <input type="number" step="any" name="d" id="d" class="input" wire:model.live="d" aria-label="input"/>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full">
                               ...
                               <table class="w-full text-[18px]">
                                    <tr>
                                        ...
                                        <td class="py-2 border-b">
                                            {{ is_numeric($detail['answer']) ? round($detail['answer'], 3) : $detail['answer'] }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="w-full text-[16px]">
                                ...
                                @if(is_float($detail['ans_f']))
                                    <p class="mt-2">
                                        = &nbsp;&nbsp;<sup>{{$d}}</sup>
                                        <span class="quadratic_square-root">({{$x}})^{{$n}}</span>
                                    </p>
                                    ...
                                    @endisset
                                @else
                                    <p class="mt-2">{{$x}}<sup class="font-s-14">{{$detail['ans_f']}}</sup></p>
                                    <p class="mt-2">{{$lang['6']}} 3:</p>
                                    <p class="mt-2">{{ $detail['answer']}}</p>
                                @endif
                            </div>
