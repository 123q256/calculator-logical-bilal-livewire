            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-7">
                    ...
                    <div class="w-100 py-2 position-relative"> 
                        <input type="number" step="any" wire:model="no1" id="no1" class="input" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-5">
                    <label for="opt1" class="label">&nbsp;</label>
                    <div class="w-100 py-2"> 
                        <select wire:model="opt1" id="opt1" class="input">
                            @php
                                $name = [
                ...
                <div class="col-span-7">
                    ...
                    <div class="w-100 py-2 position-relative"> 
                        <input type="number" step="any" wire:model="no2" id="no2" class="input" aria-label="input" />
                    </div>
                </div>
                <div class="col-span-5 lawn_mowed">
                    <label for="opt2" class="label">&nbsp;</label>
                    <div class="w-100 py-2"> 
                        <select wire:model="opt2" id="opt2" class="input">
                            @php
                                $name2 = [
                            ...
                            @endphp
                            @foreach($val2 as $index => $val_item)
                                <option value="{{ $val_item }}">{!! $name2[$index] !!}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                        ...
                        <div class="col m10 s12">
                            <div class="text-center pt-1 pb-2">
                                ...
                                <div class="flex justify-center">
                                    <p class="text-[32px] bg-[#ffffff] text-[#ff6d00] px-3 py-2 rounded-lg inline-block my-3">
                                        {{ round($detail['final_result3'], 5) }}
                                    </p>
                                </div>
                            </div>
