...
<style>
    ...
    @media (max-width: 480px){
        ...
        #lby,#lbx,#lbz{ margin-top: 5px !important }
        #ubx,#uby,#ubz{ margin-bottom: 0px !important }
    }
</style>
    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="lg:w-[80%] md:w-[80%] w-full mx-auto ">
            ...
            <div class="flex items-center align-items-center justify-content-center" id="inputsField">
                ...
                {{-- Z integral --}}
                <div class="mx-2 w-[50px]">
                    <input type="text" wire:model.live="ubz" id="ubz" class="integral_input" aria-label="input" autocomplete="off" style="margin-bottom: 5px;"/>
                    <p class="text-blue integ_symb">∫</p>
                    <input type="text" wire:model.live="lbz" id="lbz" class="integral_input" aria-label="input" autocomplete="off" style="margin-top: -5px;"/>
                </div>
                ...
                <div>
                    ...
                    <div class="w-100 py-2">
                        <select wire:model.live="with" class="input" id="with" aria-label="select">
                            ...
                            <option value="zxy">dzdxdy</option>
                            <option value="xyz">dxdydz</option>
                            <option value="xzy">dxdzdy</option>
                            <option value="yxz">dydxdz</option>
                            <option value="yzx">dydzdx</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg  flex items-center justify-center">
                <div class="w-full mt-3">
                    <div class="w-full text-[16px]">
                        ...
                        <div x-data="{ open3: false }" class="w-full my-3">
                            <button type="button" @click="open3 = !open3" class="bg-blue-700 text-white rounded px-4 py-2 hover:bg-blue-600 transition duration-300 flex items-center gap-2">
                                <span>Show Solution</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transform transition-transform duration-300" :class="open3 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            <div class="w-full mt-3 border-l-4 border-blue-500 pl-4 py-3 bg-blue-50/30 rounded-r-lg"
