       ...
       <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-full py-2">
                    <input type="text" name="exp" id="exp" class="input" wire:model.live="exp" aria-label="input"/>
                </div>
            </div>
                    ...
                    <div class="w-full mt-3">
                        <div class="w-full">
                            ...
                            <div class="w-full text-[16px]">
                                ...
                                <p class="mt-3">{{$lang['27']}} {{$lang['28']}} {{$lang['23']}} \( {!! $expand1 !!} \) {{$lang['22']}} \( {!! $r !!} \approx {{ round(sqrt($simp), 4) }} \)</p>
                            </div>
                        </div>
                    </div>
                </div>
