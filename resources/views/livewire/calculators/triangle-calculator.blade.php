            ...
            <div class="col-span-6">
                <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="w-full py-2">
                            <select name="unit" class="input" id="unit" wire:model.live="unit" aria-label="select">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full text-[16px]">
                                ...
                                @if($detail['comb']==1)
                                    ...
                                    <p class="mt-3">\( ∠A = {{safe_round($detail['Ar'],5)}} \text{ rad } = {{safe_round($detail['Ad'],5)}}° = {{$detail['At']['deg'].'°'.$detail['At']['min']."'".$detail['At']['sec'].'"'}} \)</p>
                                    ...
                                    <p class="mt-3">\( ∠B = {{safe_round($detail['Br'],5)}} \text{ rad } = {{safe_round($detail['Bd'],5)}}° = {{$detail['Bt']['deg'].'°'.$detail['Bt']['min']."'".$detail['Bt']['sec'].'"'}} \)</p>
                                    ...
                                    <p class="mt-3">\( ∠C = {{safe_round($detail['Cr'],5)}} \text{ rad } = {{safe_round($detail['Cd'],5)}}° = {{$detail['Ct']['deg'].'°'.$detail['Ct']['min']."'".$detail['Ct']['sec'].'"'}} \)</p>
                                @elseif($detail['comb']==2)
                                    <p class="mt-3">{{$lang['13']}}.</p>
                                    <p class="mt-3">\( ∠B = sin^{-1}(\frac{b\times sin(A)}{a}) \)</p>
                                    <p class="mt-3">\( ∠B = sin^{-1}(\frac{ {{$detail['b']}} \times sin({{safe_round($detail['Ar'],5)}})}{ {{$detail['a']}} }) \)</p>
                                    <p class="mt-3">\( ∠B = {{safe_round($detail['Br'],5)}} \text{ rad } = {{safe_round($detail['Bd'],5)}}° = {{$detail['Bt']['deg'].'°'.$detail['Bt']['min']."'".$detail['Bt']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( ∠C = 180° - A - B \)</p>
                                    <p class="mt-3">\( ∠C = {{safe_round($detail['Cr'],5)}} \text{ rad } = {{safe_round($detail['Cd'],5)}}° = {{$detail['Ct']['deg'].'°'.$detail['Ct']['min']."'".$detail['Ct']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( c = \frac{a \times sin(C)}{sin(A)} \)</p>
                                    <p class="mt-3">\( c = \frac{ {{$detail['a']}} \times sin({{safe_round($detail['Cr'],5)}})}{sin({{safe_round($detail['Ar'],5)}})} \)</p>
                                    <p class="mt-3">\( c = {{$detail['c']}} \)</p>
                                @elseif($detail['comb']==3)
                                    <p class="mt-3">{{$lang['15']}}.</p>
                                    <p class="mt-3">\( ∠A = sin^{-1}(\frac{a\times sin(B)}{b}) \)</p>
                                    <p class="mt-3">\( ∠A = sin^{-1}(\frac{ {{$detail['a']}} \times sin({{safe_round($detail['Br'],5)}})}{ {{$detail['b']}} }) \)</p>
                                    <p class="mt-3">\( ∠A = {{safe_round($detail['Ar'],5)}} \text{ rad } = {{safe_round($detail['Ad'],5)}}° = {{$detail['At']['deg'].'°'.$detail['At']['min']."'".$detail['At']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( ∠C = 180° - A - B \)</p>
                                    <p class="mt-3">\( ∠C = {{safe_round($detail['Cr'],5)}} \text{ rad } = {{safe_round($detail['Cd'],5)}}° = {{$detail['Ct']['deg'].'°'.$detail['Ct']['min']."'".$detail['Ct']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( c = \frac{b \times sin(C)}{sin(B)} \)</p>
                                    <p class="mt-3">\( c = \frac{ {{$detail['b']}} \times sin({{safe_round($detail['Cr'],5)}})}{sin({{safe_round($detail['Br'],5)}})} \)</p>
                                    <p class="mt-3">\( c = {{$detail['c']}} \)</p>
                                @elseif($detail['comb']==4)
                                    <p class="mt-3">{{$lang['16']}}.</p>
                                    <p class="mt-3">\( c=\sqrt{b^2 + a^2 - 2ba.cos(C)} \)</p>
                                    <p class="mt-3">\( c=\sqrt{ {{$detail['b']}}^2 + {{$detail['a']}}^2 - 2{{$detail['b']}}\times{{$detail['a']}}.cos({{safe_round($detail['Cr'],5)}})} \)</p>
                                    <p class="mt-3">\( c= {{$detail['c']}} \)</p>
                                ...
                                @elseif($detail['comb']==5)
                                    ...
                                    <p class="mt-3">\( b = \frac{ {{$detail['a']}} \times sin({{safe_round($detail['Br'],5)}})}{sin({{safe_round($detail['Ar'],5)}})} \)</p>
                                ...
                                @elseif($detail['comb']==6)
                                    ...
                                    <p class="mt-3">\( a = \frac{ {{$detail['b']}} \times sin({{safe_round($detail['Ar'],5)}})}{sin({{safe_round($detail['Br'],5)}})} \)</p>
                                ...
                                @elseif($detail['comb']==7)
                                    ...
                                    <p class="mt-3">\( a = \frac{ {{$detail['c']}} \times sin({{safe_round($detail['Ar'],5)}})}{sin({{safe_round($detail['Cr'],5)}})} \)</p>
                                    <p class="mt-3">\( a = {{$detail['a']}} \)</p>
                                    <p class="mt-3">\( c = \frac{c\times sin(B)}{sin(C)} \)</p>
                                    <p class="mt-3">\( c = \frac{ {{$detail['c']}} \times sin({{safe_round($detail['Br'],5)}})}{sin({{safe_round($detail['Cr'],5)}})} \)</p>
                                    <p class="mt-3">\( c = {{$detail['c']}} \)</p>
                                ...
                                @elseif($detail['comb']==10)
                                    ...
                                    <p class="mt-3">\( b = \frac{ {{$detail['c']}} \times sin({{safe_round($detail['Br'],5)}})}{sin({{safe_round($detail['Cr'],5)}})} \)</p>
                                    <p class="mt-3">\( b = {{$detail['b']}} \)</p>
                                ...
                                <p class="mt-3">\( {{$lang['6']}} = \frac{ {{$detail['a'].'\times'.$detail['b']}}.sin({{safe_round($detail['Cr'],5)}})}{2} = {{$detail['area']}} \)</p>
                                ...
                                <p class="mt-3">\( \text{ {{$lang['10']}} }m_a=\sqrt{(\frac{ {{$detail['a']}} }{2})^2 + {{$detail['c']}}^2 - {{$detail['a'].'\times'.$detail['c']}}.cos({{safe_round($detail['Br'],5)}})} = {{$detail['ma']}} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['10']}} }m_b=\sqrt{(\frac{b}{2})^2 + a^2 - ab.cos(C)} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['10']}} }m_b=\sqrt{(\frac{ {{$detail['b']}} }{2})^2 + {{$detail['a']}}^2 - {{$detail['a'].'\times'.$detail['b']}}.cos({{safe_round($detail['Cr'],5)}})} = {{$detail['mb']}} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['10']}} }m_c=\sqrt{(\frac{c}{2})^2 + b^2 - bc.cos(A)} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['10']}} }m_c=\sqrt{(\frac{ {{$detail['c']}} }{2})^2 + {{$detail['b']}}^2 - {{$detail['b'].'\times'.$detail['c']}}.cos({{safe_round($detail['Ar'],5)}})} = {{$detail['mc']}} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['11']}} r}=\frac{area}{s} = \frac{ {{$detail['area']}} }{ {{$detail['semi']}} } = {{$detail['inr']}} \)</p>
                                <p class="mt-3">\( \text{ {{$lang['12']}} R}=\frac{a}{2.sin(A)} = \frac{ {{$detail['a']}} }{2 \times sin({{safe_round($detail['Ar'],5)}})} = {{$detail['circ']}} \)</p>
                                @if($detail['comb']==2 && isset($detail['comb2']))
                                    ...
                                    <p class="mt-3">{{$lang['5']}} c = {{safe_round($detail['c1'],5)}}</p>
                                    <p class="mt-3">{{$lang['4']}} ∠A = {{safe_round($detail['Ar'],5)}} rad = {{safe_round($detail['Ad'],5)}}° = {{$detail['At']['deg'].'°'.$detail['At']['min']."'".$detail['At']['sec'].'"'}}</p>
                                    <p class="mt-3">{{$lang['4']}} ∠B = {{safe_round($detail['Br1'],5)}} rad = {{safe_round($detail['Bd1'],5)}}° = {{$detail['Bt1']['deg'].'°'.$detail['Bt1']['min']."'".$detail['Bt1']['sec'].'"'}}</p>
                                    <p class="mt-3">{{$lang['4']}} ∠C = {{safe_round($detail['Cr1'],5)}} rad = {{safe_round($detail['Cd1'],5)}}° = {{$detail['Ct1']['deg'].'°'.$detail['Ct1']['min']."'".$detail['Ct1']['sec'].'"'}}</p>
                                    ...
                                    <p class="mt-3">\( ∠B = 180° - sin^{-1}(\frac{ {{$detail['b']}} \times sin({{safe_round($detail['Ar'],5)}})}{ {{$detail['a']}} }) \)</p>
                                    <p class="mt-3">\( ∠B = {{safe_round($detail['Br1'],5)}} \text{ rad } = {{safe_round($detail['Bd1'],5)}}° = {{$detail['Bt1']['deg'].'°'.$detail['Bt1']['min']."'".$detail['Bt1']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( ∠C = 180° - A - B \)</p>
                                    <p class="mt-3">\( ∠C = {{safe_round($detail['Cr1'],5)}} \text{ rad } = {{safe_round($detail['Cd1'],5)}}° = {{$detail['Ct1']['deg'].'°'.$detail['Ct1']['min']."'".$detail['Ct1']['sec'].'"'}} \)</p>
                                    <p class="mt-3">\( c = \frac{a \times sin(C)}{sin(A)} \)</p>
                                    <p class="mt-3">\( c = \frac{ {{$detail['a']}} \times sin({{safe_round($detail['Cr1'],5)}})}{sin({{safe_round($detail['Ar'],5)}})} \)</p>
                                    <p class="mt-3">\( c = {{safe_round($detail['c1'],5)}} \)</p>
                                    <p class="mt-3">\( {{$lang['6']}} = \frac{ab.sin(C)}{2} \)</p>
                                    <p class="mt-3">\( {{$lang['6']}} = \frac{ {{$detail['a'].'\times'.$detail['b']}}.sin({{safe_round($detail['Cr1'],5)}})}{2} = {{$detail['area1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['8']}} p} = a + b + c \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['8']}} p} = {{$detail['a']}} + {{$detail['b']}} + {{safe_round($detail['c1'],5)}} = {{$detail['peri1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['7']}} s} = \frac{a + b + c}{2} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['7']}} s} = \frac{ {{$detail['a']}} + {{$detail['b']}} + {{safe_round($detail['c1'],5)}} }{2} = {{$detail['semi1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['9']}} }h_a=\frac{2 \times \text{ Area}}{a} \)</p>
                                    ...
                                    <p class="mt-3">\( \text{ {{$lang['9']}} }h_c=\frac{2 \times \text{ Area}}{c} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['9']}} }h_c=\frac{2 \times {{$detail['area1']}} }{ {{safe_round($detail['c1'],5)}} } = {{$detail['hc1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_a=\sqrt{(\frac{a}{2})^2 + c^2 - ac.cos(B)} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_a=\sqrt{(\frac{ {{$detail['a']}} }{2})^2 + {{safe_round($detail['c1'],5)}}^2 - {{$detail['a'].'\times'.safe_round($detail['c1'],5)}}.cos({{safe_round($detail['Br1'],5)}})} = {{$detail['ma1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_b=\sqrt{(\frac{b}{2})^2 + a^2 - ab.cos(C)} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_b=\sqrt{(\frac{ {{$detail['b']}} }{2})^2 + {{$detail['a']}}^2 - {{$detail['a'].'\times'.$detail['b']}}.cos({{safe_round($detail['Cr1'],5)}})} = {{$detail['mb1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_c=\sqrt{(\frac{c}{2})^2 + b^2 - bc.cos(A)} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['10']}} }m_c=\sqrt{(\frac{ {{safe_round($detail['c1'],5)}} }{2})^2 + {{$detail['b']}}^2 - {{$detail['b'].'\times'.safe_round($detail['c1'],5)}}.cos({{safe_round($detail['Ar'],5)}})} = {{$detail['mc1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['11']}} r}=\frac{area}{s} = \frac{ {{$detail['area1']}} }{ {{$detail['semi1']}} } = {{$detail['inr1']}} \)</p>
                                    <p class="mt-3">\( \text{ {{$lang['12']}} R}=\frac{a}{2.sin(A)} = \frac{ {{$detail['a']}} }{2 \times sin({{safe_round($detail['Ar'],5)}})} = {{$detail['circ1']}} \)</p>
                                @endif
                            </div>
                        </div>
                    </div>
