...
.quadratic_fraction .num {
 ...
 <form wire:submit.prevent="calculate">
                ...
                <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    <div class="col-span-4">
                        ...
                        <div class="w-100 py-2">
                            <input type="number" name="hh" id="hh" min="0" maxlength="2" class="input" wire:model.live="hh" aria-label="input" />
                        </div>
                    </div>
                    <div class="col-span-4">
                        <label for="mm" class="label">MM:</label>
                        <div class="w-100 py-2">
                            <input type="number" name="mm" id="mm" min="0" maxlength="2" class="input" wire:model.live="mm" aria-label="input" />
                        </div>
                    </div>
                    <div class="col-span-4">
                        <label for="ss" class="label">SS:</label>
                        <div class="w-100 py-2">
                            <input type="number" name="ss" id="ss" min="0" maxlength="2" class="input" wire:model.live="ss" aria-label="input" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if(isset($detail) && isset($detail['hours']))
    <hr>
