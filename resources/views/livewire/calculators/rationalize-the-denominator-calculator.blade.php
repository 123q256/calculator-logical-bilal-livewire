...
<form wire:submit.prevent="calculate">
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       @endif
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto " x-data="{ type_mode: @entangle('type_mode'), ops: @entangle('operations') }">
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-12" id="simpleMethod" x-show="type_mode === 'first'">
                    <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                        <div class="col-span-12 px-2">
                            ...
                            <p class="col-span-12 text-[20px] mt-0 mt-lg-2 text-center" x-show="ops == '1'">
                                \( \frac{a\sqrt[n]b}{x\sqrt[k]y} \ = \ ? \)
                            </p>
                            <p class="col-span-12 text-[20px] mt-0 mt-lg-2 text-center" x-show="ops == '2'">
                                \( \frac{ a\sqrt[n]b+c\sqrt[m]d }{ x\sqrt[k]y } \ = \ ? \)
                            </p>
                            <p class="col-span-12 text-[20px] mt-0 mt-lg-2 text-center" x-show="ops == '3'">
                                \( \frac{ a\sqrt{b} }{ x\sqrt{y}+z\sqrt{u} } \ = \ ? \)
                            </p>
                            <p class="col-span-12 text-[20px] mt-0 mt-lg-2 text-center" x-show="ops == '4'">
                        ...
                        <div class="col-span-4" id="nInput" x-show="ops != '3' && ops != '4'">
                        ...
                        <div class="col-span-4" id="cInput" x-show="ops == '2' || ops == '4'">
                        ...
                        <div class="col-span-4" id="dInput" x-show="ops == '2' || ops == '4'">
                        ...
                        <div class="col-span-4" id="mInput" x-show="ops == '2'">
                        ...
                        <div class="col-span-4" id="uInput" x-show="ops == '3' || ops == '4'">
                ...
                <div class="col-span-12 mt-0 mt-lg-2" id="advanceMethod" x-show="type_mode === 'second'" x-cloak>
                        ...
                        <div class="w-full">
                            @if ($type_mode === 'first')
                                ...
                                <div class="w-full text-[16px]">
                                    ...
                                    <div class="w-full all_result" wire:ignore>
                                        <p class="mt-3"></p>
                                    </div>
...
<script>
    window._rtd_operations = 1;
    window._rtd_a = 1; window._rtd_b = 1; window._rtd_c = 1; window._rtd_d = 1;
    window._rtd_n = 2; window._rtd_m = 2; window._rtd_x = 1; window._rtd_y = 1;
    window._rtd_k = 2; window._rtd_z = 1; window._rtd_u = 1;
</script>
<script>
            ...
            function calculate() {
                var expression = _rtd_operations;
                var a = _rtd_a;
                var b = _rtd_b;
                var c = _rtd_c;
                var d = _rtd_d;
