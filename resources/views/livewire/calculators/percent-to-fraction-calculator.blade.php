       ...
       <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-100 py-2 relative">
                    <input type="number" step="any" wire:model.live="percent" name="percent" id="percent" class="input" aria-label="input"/>
                        ...
                        <div class="w-full">
                            <div class="w-full md:w-[80%] lg:w-[80%] mt-2">
                                <table class="w-full text-[18px]">
                                    <tr>
                                        <td class="py-2 border-b" width="55%"><strong>{{$lang['ans']}} {{ $percent }}% = </strong></td>
