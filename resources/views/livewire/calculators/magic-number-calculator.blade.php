            ...
            <div class="lg:w-[60%] md:w-[60%] w-full mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4">
                    <div class="space-y-2 relative">
                        ...
                        <input type="number" wire:model.live.debounce.500ms="win" step="any" id="win" class="input" aria-label="input" placeholder="00" />
                    </div>
                    <div class="space-y-2">
                        <label for="loss" class="font-s-14 text-blue">{{ $lang['2'] }}:</label>
                        <input type="number" wire:model.live.debounce.500ms="loss" step="any" id="loss" class="input" aria-label="input" placeholder="00" />
                    </div>
                </div>
            </div>
