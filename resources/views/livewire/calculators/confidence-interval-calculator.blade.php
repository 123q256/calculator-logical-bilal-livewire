           ...
           <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
                <div class="grid grid-cols-12 mt-3  gap-4">
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-6">
                        ...
                        <div class="w-100 py-2">
                            <input type="number" step="any" wire:model.live="s" id="s" class="input" aria-label="input" placeholder="00" />
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-6 lg:col-span-6">
                        <label for="n" class="font-s-14 text-blue">{{ $lang['3'] }} (n)</label>
                        <div class="w-100 py-2">
                            <input type="number" step="any" wire:model.live="n" id="n" min="1" class="input" aria-label="input" placeholder="00" />
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-6 lg:col-span-6">
                        <label for="cl" class="font-s-14 text-blue">{{ $lang['4'] }}</label>
                        <div class="w-100 py-2 relative">
                            <input type="number" step="any" wire:model.live="cl" id="cl" min="0" max="99.99" class="input" aria-label="input" placeholder="00" />
                            <span class="text-blue input_unit">%</span>
                        </div>
                    </div>
                </div>
                <input type="hidden" wire:model="z" id="rs">
           </div>
            @if ($type == 'calculator')
            @include('inc.button')
           @endif
