       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-100 py-2 position-relative">
                    <input type="number" step="any" wire:model.live="cigarettes" id="cigarettes" class="input" aria-label="input" placeholder="00" />
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-100 py-2 position-relative">
                    <input type="number" step="any" wire:model.live="size" id="size" class="input" aria-label="input" placeholder="00" />
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-100 py-2 position-relative">
                    <input type="number" step="any" wire:model.live="years" id="years" class="input" aria-label="input" placeholder="00" />
