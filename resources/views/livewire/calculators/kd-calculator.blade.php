                ...
                <div class="grid grid-cols-12 mt-3 gap-4">
                    <div class="col-span-12 md:col-span-4 lg:col-span-4">
                        ...
                        <div class="w-100 py-2">
                            <input type="number" wire:model.live="kills" id="kills" class="input" aria-label="input" placeholder="12" />
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-4 lg:col-span-4">
                        <label for="deaths" class="font-s-14 text-blue">{{ $lang['2'] }}:</label>
                        <div class="w-100 py-2">
                            <input type="number" wire:model.live="deaths" id="deaths" class="input" aria-label="input" placeholder="23" />
                        </div>
                    </div>
                    <div class="col-span-12 md:col-span-4 lg:col-span-4">
                        <label for="assists" class="font-s-14 text-blue">{{ $lang['3'] }}:</label>
                        <div class="w-100 py-2 relative">
                            <input type="number" wire:model.live="assists" id="assists" class="input" aria-label="input" />
