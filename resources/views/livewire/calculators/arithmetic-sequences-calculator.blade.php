            ...
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div class="col-span-12">
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" name="first" id="first" class="input" wire:model.live="first" aria-label="input"/>
                    </div>
                </div>
                <div class="col-span-12">
                    <label for="diff" class="font-s-14 text-blue">{{$lang['2']}} (f):</label>
                    <div class="w-full py-2">
                        <input type="number" step="any" name="diff" id="diff" class="input" wire:model.live="diff" aria-label="input"/>
                    </div>
                </div>
                <div class="col-span-12">
                    <label for="nth" class="font-s-14 text-blue">{{$lang['3']}}:</label>
                    <div class="w-full py-2">
                        <input type="number" step="any" name="nth" id="nth" class="input" wire:model.live="nth" aria-label="input"/>
                    </div>
                </div>
        </div>
    </div>
