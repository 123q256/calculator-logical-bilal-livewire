       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-4">
                ...
                <div class="w-100 py-2">
                    <input type="number" step="any" name="A" id="A" class="input" wire:model.live="A" aria-label="input" required />
                </div>
            </div>
            <div class="col-span-4">
                <label for="B" class="font-s-14 text-blue">B</label>
                <div class="w-100 py-2">
                    <input type="number" step="any" name="B" id="B" class="input" wire:model.live="B" aria-label="input" required />
                </div>
            </div>
            <div class="col-span-4">
                <label for="C" class="font-s-14 text-blue">C</label>
                <div class="w-100 py-2">
                    <input type="number" step="any" name="C" id="C" class="input" wire:model.live="C" aria-label="input" required />
                </div>
            </div>
        </div>
    </div>
