    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="lg:w-[100%] md:w-[100%] w-full mx-auto ">
            ...
            <div class="col-span-2">
                <select wire:model.live="matrix2" name="matrix2" class="input input1" id="rows2" aria-label="select">
                    @for ($i = 1; $i <= 10; $i++)
            ...
            <div class="col-span-2">
                <select wire:model.live="matrix22" name="matrix22" class="input input2" id="columns2" aria-label="select">
                    @for ($i = 1; $i <= 10; $i++)
                        <option value="{{ $i }}">{{ $i }}</option>
                    @endfor
                </select>
