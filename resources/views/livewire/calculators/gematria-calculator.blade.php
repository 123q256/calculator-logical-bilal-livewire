            ...
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div class="col-span-12 two mt-1">
                    <label for="input" class="font-s-14">{{ $lang['1'] }} e.g:
                        <span wire:click="$set('input', 'Heaven'); calculate()" class="ps-1 text-decoration-underline link cursor-pointer text-blue">Heaven</span>,
                        <span wire:click="$set('input', 'Beast'); calculate()" class="text-decoration-underline link cursor-pointer text-blue">Beast</span>,
                        <span wire:click="$set('input', 'Earth'); calculate()" class="text-decoration-underline link cursor-pointer text-blue">Earth</span>
                    </label>
                    <div class="w-100 py-2">
                        <input type="text" id="input" wire:model.live="input" class="input" aria-label="input" placeholder="00" required />
                    </div>
                </div>
        </div>
    </div>
...
<hr>
    <div id="result-section" wire:loading.remove wire:target="calculate" x-data="{ showStep2: false, showStep3: false, showStep4: false, showStep5: false, showStep6: false, showStep8: false }" class="w-full mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg  space-y-6 result">
            <div class="">
                    @if ($type == 'calculator')
                    ...
                    <div class="w-full bg-light-blue  p-3 radius-10 mt-3">
                        <div class="row">
                            <div class="w-full" id="res_step1">
                                <div class="row">
                                    {{-- harbw --}}
                                    <p class="w-full mt-2 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time5" @click="showStep5 = !showStep5"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[9] ?> 
                                    ...
                                    <div class="w-full " id="res_step5" x-show="showStep5" x-cloak>
                                    ...
                                    {{-- english --}}
                                    <p class="w-full mt-3 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time6" @click="showStep6 = !showStep6"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[8] ?> 
                                    ...
                                    <div class="w-full " id="res_step6" x-show="showStep6" x-cloak>
                                        <div class="w-full mt-3 over overflow-auto">
                                            <table class="w-100" style='border-collapse: collapse'>
                                                <tr class="bg-gray">
                                    ...
                                    {{-- simple --}}
                                    <p class="w-full mt-3 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time8" @click="showStep8 = !showStep8"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[3] ?> 
                                        <img src="{{asset('images/keyboard.png')}}" width="30px" height="30px" alt="More info" class="ps-1">
                                    </strong></p>
                                    ...
                                    ?> --}}
                                    <div class="row">
                                        <div id="res_step8" x-show="showStep8" x-cloak>
                                ...
                                {{-- reduction --}}
                                <p class="w-full mt-3 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time2" @click="showStep2 = !showStep2"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[4] ?> 
                                    <img src="{{asset('images/keyboard.png')}}" width="30px" height="30px" alt="More info" class="ps-1"></strong></p>
                                ...
                                <div class="w-full" id="res_step2" x-show="showStep2" x-cloak>
                                    <div class="row">
                                        <div class="w-full mt-3 overflow-auto">
                                            <table class="w-100" style='border-collapse: collapse'>
                                                <tr class="bg-gray">
                                ...
                                {{-- Reverse --}}
                                <p class="w-full mt-3 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time3" @click="showStep3 = !showStep3"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[5] ?> 
                                    <img src="{{asset('images/keyboard.png')}}" width="30px" height="30px" alt="More info" class="ps-1"></strong></p>
                                ...
                                <div class="w-full mt-3" id="res_step3" x-show="showStep3" x-cloak>
                                    <div class="w-full mt-3 over overflow-auto">
                                        <table class="w-100" style='border-collapse: collapse'>
                                            <tr class="bg-gray">
                                ...
                                {{-- Reverse Reduction --}}
                                <p class="w-full mt-3 font-s-18 cursor-pointer mb-lg-0 mb-3" id="first_time4" @click="showStep4 = !showStep4"><strong class="d-flex align-items-center text-blue hov_line text-decoration-underline"><?= $lang[6] ?> 
                                    <img src="{{asset('images/keyboard.png')}}" width="30px" height="30px" alt="More info" class="ps-1"></strong></p>
                                ...
                                <div class="w-full mt-3" id="res_step4" x-show="showStep4" x-cloak>
                                    <div class="w-full mt-3 over overflow-auto">
                                        <table class="w-full" style='border-collapse: collapse'>
                                            <tr class="bg-gray">
...
<!-- Slide Toggles handled smoothly and reactively by Alpine.js -->
</div>
