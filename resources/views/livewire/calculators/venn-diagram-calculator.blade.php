...
<style>
 ...
 <form wire:submit.prevent="calculate" x-data="{ selection: $wire.entangle('selection') }">
      ...
      <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="col-12 col-lg-9 mx-auto mt-2  w-full">
          <div class="flex flex-wrap items-center bg-blue-100 border border-blue-500 text-center rounded-lg px-1 pacetabs">
              <div class="lg:w-1/2 w-full px-2 py-1">
                  <div class="bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300  hover_tags hover:text-white  pacetab" :class="selection === 'twoset' ? 'tagsUnit' : ''" @click="selection = 'twoset'">
                          {{ $lang['1'] }}
                  </div>
              </div>
              <div class="lg:w-1/2 w-full px-2 py-1">
                  <div class="bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300  hover_tags hover:text-white pacetab" :class="selection === 'threeset' ? 'tagsUnit' : ''" @click="selection = 'threeset'">
                          {{ $lang['2'] }}
                  </div>
              </div>
          </div>
       ...
       <div class="lg:w-[80%] md:w-[80%] w-full mx-auto ">
            ...
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                  <div class="col-span-12 mt-3 toset" x-show="selection === 'twoset'">
                    <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <div class="col-span-12">
                          <label for="venn_name" class="font-s-14 text-blue"><?= $lang[3] ?>:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="venn_name" id="venn_name" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                          <label for="A" class="font-s-14 text-blue"><?= $lang[4] ?>:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="ta" id="A" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                          <label for="B" class="font-s-14 text-blue" >{{ $lang['5'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="tb" id="B" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                  ...
                  <div class="col-span-12 threeset mt-3" x-show="selection === 'threeset'" x-cloak style="display: none;">
                    <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <div class="col-span-12">
                          <label for="venn_name3" class="font-s-14 text-blue"><?= $lang[3] ?>:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="venn_name3" id="venn_name3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="ta3" class="font-s-14 text-blue"><?= $lang[4] ?>:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="ta3" id="ta3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="tb3" class="font-s-14 text-blue" >{{ $lang['5'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="tb3" id="tb3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="tc3" class="font-s-14 text-blue" >{{ $lang['6'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="text" wire:model.live="tc3" id="tc3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                      ...
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          ...
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="b3" id="b3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="cc3" class="font-s-14 text-blue" >{{ $lang['9'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="c3" id="cc3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12">
                          <label for="u3" class="font-s-14 text-blue" >{{ $lang['8'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="u3" id="u3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      ...
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          ...
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="anb3" id="anb3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="bnc3" class="font-s-14 text-blue" >{{ $lang['12'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="bnc3" id="bnc3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      <div class="col-span-12 md:col-span-4 lg:col-span-4">
                          <label for="cna3" class="font-s-14 text-blue" >{{ $lang['13'] }}:</label>
                          <div class="w-100 py-2">
                              <input type="number" wire:model.live="cna3" id="cna3" class="input" aria-label="input"/>
                          </div>
                      </div>
                      ...
                      <div class="col-span-12">
                          ...
                          <div class="w-100 py-2">
                              <input type="number" step="any" wire:model.live="anbnc" id="anbnc" class="input" aria-label="input"/>
                          </div>
                      </div>
                    </div>
                  </div>
