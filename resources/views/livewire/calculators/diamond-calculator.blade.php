                ...
                <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="w-full py-2">
                            <input type="number" step="any" id="factor_a" class="input" aria-label="input" wire:model.live="factor_a" />
                        </div>
                    </div>
                    <div class="col-span-6">
                        <label for="factor_b" class="font-s-14 text-blue"><?= $lang['2'] ?> (B):</label>
                        <div class="w-full py-2">
                            <input type="number" step="any" id="factor_b" class="input" aria-label="input" wire:model.live="factor_b" />
                        </div>
                    </div>
                    <div class="col-span-6">
                        <label for="product" class="font-s-14 text-blue"><?= $lang['1'] ?>:</label>
                        <div class="w-full py-2">
                            <input type="number" step="any" id="product" class="input" aria-label="input" wire:model.live="product" />
                        </div>
                    </div>
                    <div class="col-span-6">
                        <label for="sum" class="font-s-14 text-blue"><?= $lang['5'] ?>:</label>
                        <div class="w-full py-2">
                            <input type="number" step="any" id="sum" class="input" aria-label="input" wire:model.live="sum" />
                        </div>
                    </div>
                </div>
            </div>
