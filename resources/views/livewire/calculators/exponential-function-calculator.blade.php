       ...
       <div class="lg:w-[70%] md:w-[70%] w-full mx-auto ">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="t1" id="t1" class="input" aria-label="input" />
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="t2" id="t2" class="input" aria-label="input" />
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="point_optional" id="point_optional" class="input" aria-label="input" />
                </div>
            </div>
        </div>
    </div>
                                 ...
                                 x-data="{
                                     initChart() {
                                         ...
                                         this.$nextTick(() => {
                                             ...
                                             var time = parseFloat(t) + 8;
                                             for(var i=0.01; i<=time; i+=0.1){
                                                 var e = Math.exp(k*i);
                                                 var f = A*e;
                                                 data.addRow([parseFloat(i), parseFloat(f)]);
                                             }
                                             var options = {
                                                 colors: ['#13699E'],
                                                 lineWidth: 1,
