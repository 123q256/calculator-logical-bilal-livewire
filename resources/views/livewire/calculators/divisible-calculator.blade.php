          ...
          <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
            <div class="col-span-12">
                ...
                <div class="w-100 py-2">
                    <input type="number" step="any" wire:model.live="no" id="no" class="input" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-12">
                <label for="divisible" class="font-s-14 text-blue">{{ $lang['2'] }}:</label>
                <div class="w-100 py-2">
                    <input type="number" step="any" wire:model.live="divisible" id="divisible" class="input" aria-label="input"/>
                </div>
            </div>
          </div>
        </div>
                ...
                <div class="w-full mt-3">
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full text-[16px] overflow-auto">
                            ...
                            <div class="w-full lg:w-[80%] my-3 tableAns">
