        ...
        <div class="lg:w-[60%] md:w-[60%] w-full mx-auto">
            <div class="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                    ...
                    <div class="w-100 py-2 relative">
                        <input type="number" step="any" wire:model.live="RHR" id="RHR" class="input" aria-label="input" placeholder="00" />
                    ...
                    <div class="w-full mt-5">
                        <div class="col-12">
                            ...
                            @if (is_numeric($detail['karvonen_lower']) && is_numeric($detail['karvonen_upper']))
                                ...
                                <p>THR = [{{ round($detail['HRR'] * 60 / 100) }} + {{ $RHR }}] - [{{ round($detail['HRR'] * 80 / 100) }} + {{ $RHR }}]</p>
