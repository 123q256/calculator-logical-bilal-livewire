       ...
       <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-100 py-2">
                    <input type="number" step="any" wire:model.live="product" id="product" class="input" aria-label="input" />
                </div>
            </div>
            <div class="col-span-12">
                    ...
                    <div class="w-full mt-3">
                        <div class="w-full">
                            <div class="w-full  text-[16px]">
                                <p class="mt-3"><strong>{{$detail['roots']}}</strong></p>
                                <p class="mt-3"><strong>{{$lang['4']}}:</strong></p>
                                <p class="mt-3">{{$lang[1]}}(x.y) = {{$product}}</p>
                                <p class="mt-3">{{$lang[2]}}(x+y) = {{$sum}}</p>
                                <p class="mt-3">y = {{$sum}} - x</p>
                                <p class="mt-3">{{$lang[5]}} y in x.y = {{$product}}</p>
                                <p class="mt-3">
