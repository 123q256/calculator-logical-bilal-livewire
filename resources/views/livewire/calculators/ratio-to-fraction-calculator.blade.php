       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-full py-2">
                    <select class="input" aria-label="select" wire:model.live="convert" id="convert">
            ...
            <div class="col-span-12">
                ...
                <div class="w-full py-2">
                    <select class="input" aria-label="select" wire:model.live="select_unit" id="select_unit">
            ...
            <div class="col-span-12 flex tems-center px-2">
                <div>
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" id="first_number" class="input" wire:model.live="first_number" aria-label="input"/>
                    </div>
                </div>
                <div class="dot px-2 flex items-center pt-4">
                    <p>&nbsp;</p>
                    <div class="mb-2">
                        <strong id="dotText">{{ $convert == '2' ? '/' : ':' }}</strong>
                    </div>
                </div>
                <div>
                    ...
                    <div class="w-full py-2">
                        <input type="number" step="any" id="second_number" class="input" wire:model.live="second_number" aria-label="input"/>
                    </div>
                </div>
            </div>
        </div>
