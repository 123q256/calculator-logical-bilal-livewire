                    ...
                    <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                        <div class="col-span-6">
                            ...
                            <div class="w-full py-2">
                                <input type="number" step="any" id="a" class="input" wire:model.live="a" aria-label="input"/>
                            </div>
                        </div>
                        <div class="col-span-6">
                            <label for="c" class="font-s-14 text-blue">C:</label>
                            <div class="w-full py-2 position-relative">
                                <input type="number" step="any" id="c" class="input" wire:model.live="c" aria-label="input"/>
                            </div>
                        </div>
                        <div class="col-span-6">
                            <label for="b" class="font-s-14 text-blue">B:</label>
                            <div class="w-full py-2">
                                <input type="number" step="any" id="b" class="input" wire:model.live="b" aria-label="input"/>
                            </div>
                        </div>
                        <div class="col-span-6">
                            <label for="d" class="font-s-14 text-blue">D:</label>
                            <div class="w-full py-2">
                                <input type="number" step="any" id="d" class="input" wire:model.live="d" aria-label="input"/>
                            </div>
                        </div>
                    </div>
                </div>
