       ...
       <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-full py-2 relative">
                    <input type="number" step="any" wire:model.live="percentage" id="percentage" class="input" aria-label="input" />
                ...
                <div class="w-full mt-3">
                    <div class="w-full">
                        ...
                        <div class="w-full text-[16px] mt-2">          
                            ...
                            <p class="mt-2">{{$lang[2]}} = √({{$percentage}}) × 10</p>
                            <p class="mt-2">{{$lang[2]}} = {{safe_round($detail['answer'], 3)}}</p>
                        </div>
                    </div>
                </div>
            </div>
