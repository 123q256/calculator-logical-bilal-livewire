       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-100 py-2">
                    <input type="text" wire:model.live="eq" name="eq" id="eq" class="input" aria-label="input" />
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="w-full mt-3">
                    <div class="row">
                        ...
                        <div class="w-full text-[17px]">
                            ...
                            <p class="mt-2">
                                {{$lang[7]}}:
                                <a href="{{ url('graphing-calculator') }}/" class="text-blue-500 underline" target="_blank">{{$lang[6]}}</a>
                            </p>
                        </div>
                    </div>
                </div>
