                ...
                <div class="grid grid-cols-12 mt-3 gap-4">
                    <div class="col-span-12">
                        ...
                        <div class="w-100 py-2">
                            <input type="date" wire:model.live="input" id="input" class="input" aria-label="input" />
                        </div>
                    </div>
                    <div class="col-span-12">
                        <label for="input2" class="text-[14px] text-blue">{{ $lang['2'] ?? 'End Date' }}:</label>
                        <div class="w-100 py-2">
                            <input type="date" wire:model.live="input2" id="input2" class="input" aria-label="input" />
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="w-full my-2">
                                    <div class="w-full md:w-[60%] lg:w-[60%]">
                                        ...
                                        <div class="text-center">
                                            <p class="text-[18px] mt-3 mb-2">
                                                <strong class="text-[#119154] text-[22px]">{{ $detail['years'] }} </strong> {{ $lang[4] }},
                                                <strong class="text-green-700 text-[22px]">{{ $detail['months'] }}</strong> {{ $lang[5] }} {{ $lang[6] }}
                                                <strong class="text-green-700 text-[22px]">{{ $detail['days'] }}</strong> {{ $lang[7] }}
                                            </p>
                                        </div>
                                        <div class="overflow-auto w-full">                                            
                                            <table class="w-full text-[18px] mt-4">
                                            <tr>
