                                ...
                                <table class="w-full text-[18px]">
                                    @php
                                        ...
                                        $specialValues = [
                                            "1.73205081" => "\sqrt 3",
                                            "-1.73205081" => "-\sqrt 3",
                                            "0.57735027" => "{1 \over \sqrt 3} = {\sqrt 3 \over 3}",
                                            "-0.57735027" => "{-1 \over \sqrt 3} = -{\sqrt 3 \over 3}"
                                        ];
                                        ...
                                        if ($angle_unit === 'deg') {
                                            foreach ($specialValues as $key => $latex) {
                                                if (abs(floatval($tanVal) - floatval($key)) < 0.00001) {
                                                    $radicalVal = $latex;
                                                    break;
                                                }
                                            }
                                    ...
                                    @if(!empty($radicalVal))
                                        <tr>
                                            <td class="py-2 border-b" width="60%"><strong>tan({{ $angle }}{{ $unitLabel }})</strong></td>
                                    ...
                                    <tr>
                                        <td class="py-2 border-b" width="60%"><strong>tan({{ $angle }}{{ $unitLabel }})</strong></td>
                                        <td class="py-2 border-b">{{ $tanVal }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
