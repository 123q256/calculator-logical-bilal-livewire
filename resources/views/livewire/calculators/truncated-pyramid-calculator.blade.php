       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="ubl" id="ubl" class="input" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                <label for="ubw" class="label">{{$lang['2']}}</label>
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="ubw" id="ubw" class="input" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                <label for="lbl" class="label">{{$lang['3']}}</label>
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="lbl" id="lbl" class="input" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                <label for="lbw" class="label">{{$lang['4']}}</label>
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="lbw" id="lbw" class="input" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-12 md:col-span-6 lg:col-span-6">
                <label for="height" class="label">{{$lang['5']}}</label>
                <div class="w-full py-2">
                    <input type="number" step="any" wire:model.live="height" id="height" class="input" aria-label="input"/>
                </div>
            </div>
        </div>
    </div>
