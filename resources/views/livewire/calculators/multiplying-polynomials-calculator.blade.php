       ...
       <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-100 py-2">
                    <input type="text" name="first" id="first" wire:model.live="first" class="input" aria-label="input" />
                </div>
            </div>
            <div class="col-span-12">
                <label for="second" class="font-s-14 text-blue">{{$lang['2']}}:</label>
                <div class="w-100 py-2">
                    <input type="text" name="second" id="second" wire:model.live="second" class="input" aria-label="input" />
                </div>
            </div>
        </div>
    </div>
