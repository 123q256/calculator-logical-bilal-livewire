                ...
                <div class="grid grid-cols-12 mt-3 gap-4">
                    <div class="col-span-6">
                        ...
                        <div class="w-100 py-2 position-relative">
                            <input type="text" wire:model.live="name" id="name" class="input" aria-label="input" placeholder="{{ $lang['1'] }}" />
                        </div>
                    </div>
                    
                    <div class="col-span-6">
                        <label for="resident" class="label">{{ $lang['2'] }}:</label>
                        <select wire:model.live="resident" id="resident" class="input my-2">
                    ...
                    <div class="col-span-6">
                        ...
                        <select wire:model.live="nationality" id="nationality" class="input my-2">
                            <option value="">[{{$lang[3]}}]</option>
                            <option value="Afghanistan">Afghanistan</option>
                            <option value="Albania">Albania</option>
                            <option value="Algeria">Algeria</option>
                    ...
                    <div class="col-span-6">
                        ...
                        <select wire:model.live="travel" id="travel" class="input my-2">
                            <option value="">[{{$lang[3]}}]</option>
