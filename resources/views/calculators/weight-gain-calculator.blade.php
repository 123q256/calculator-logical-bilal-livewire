...
<form class="row" action="{{ url()->current() }}/" method="POST">
    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="lg:w-[80%] md:w-[80%] w-full mx-auto ">
           <div class="  mx-auto mt-2 w-full justify-end flex">
            ...
            <div class="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4 mt-4">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6 ft_in">
                    <label for="height_ft" class="label">{!! $lang['height'] !!} (ft/in):</label>
                    <div class="w-full py-2 relative">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                    <label for="weight" class="label">{!! $lang['weight'] !!} <span class="text-blue text">(lbs)</span></label>
                    <div class="w-full py-2 relative">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                    <label for="weight1" class="label">{!! $lang['i_want'] !!} <span class="text-blue text">(lbs)</span></label>
                    <div class="w-full py-2 relative">
                        <input type="number" step="any" name="weight1" id="weight1" class="input" min="1" aria-label="input" placeholder="0.0" value="{{ isset(request()->weight1)?request()->weight1:'10' }}" />
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                @if($device !== 'desktop')
                    <div class="col-lg-6 px-2 surplus hidden">
                        ...
                        <div class="w-full py-2 relative kal_day">
                        ...
                        <div class="w-full py-2 relative hidden" id="pre_cal">
                ...
                @endif
                <div class="col-span-12 md:col-span-6 lg:col-span-6 body_percent">
                    <label for="percent" class="label">
                        {!! $lang['body_fat'] !!}
                        <a title="Body Fat Percentage Calculator" href="{{ url('body-fat-percentage-calculator') }}/" class="underline text-[12px]" target="_blank" rel="noopener"> {{ $lang['click'] }}</a>:
                    </label>
                    <div class="w-full py-2 relative">
                ...
                @endif
                <div class="col-span-12 px-2 my-2"><strong class="text-blue">{{ $lang['to_achieve'] }}?</strong></div>
                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full p-3 mt-3">
                        <div class="w-full">
                            <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-2" style="border: 1px solid #c1b8b899;">
                                        <div class=""><strong class="text-[18px] text-blue-500">{{ $lang['39'] }}</strong></div>
                                ...
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-2" style="border: 1px solid #c1b8b899;">
                                        <div class=""><strong class="text-[18px] text-blue-500">{{ $lang['11'] }}</strong></div>
                                        <div class="border-s-dark ps-2">
                                ...
                                <div class="col-span-12 ">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-2" style="border: 1px solid #c1b8b899;">
                                        <div class="border-end pe-2 pe-lg-3">
                                            <div class="mb-1" class=""><strong class="text-[18px] text-blue-500">{{ $lang['22'] }}</strong></div>
                                            <div>{{ $lang['56'] }}</div>
                                        </div>
                                ...
                                <div class="col-span-12 ">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-2" style="border: 1px solid #c1b8b899;">
                                        <div class="border-end pe-2 pe-lg-3">
                                            <div class="mb-1" class=""><strong class="text-[18px] text-blue-500">TDEE</strong></div>
                                            <div>{{ $lang['57'] }}</div>
                                        </div>
                                        <div class="ps-2 ps-lg-3">
                                ...
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-2" style="border: 1px solid #c1b8b899;">
                                        <div class=""><strong class="text-[18px] text-blue-500">{{ $lang['40'] }}</strong></div>
                                ...
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                    <div class="flex items-center justify-between bg-[#F6FAFC] border rounded-lg px-3 py-3" style="min-height:64px;border: 1px solid #c1b8b899;">
                                        <div class=""><strong class="text-[18px] text-blue-500">{{ $lang['Target_Date'] }}</strong></div>
                                        <div class="border-s-dark ps-2">
                                            <div>
                            ...
                            <p class="mt-2" class=""><strong class="text-[18px] text-blue-500">{{ $lang[58] }}</strong></p>
                            <p class="">{{ $lang[59] }}</p>
                            <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4 my-3  ">
                                <div class="col-span-12 md:col-span-6 lg:col-span-6"><strong class="text-blue">{{ $lang[60] }}</strong></div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                            ...
                            <div class="w-full  mx-auto my-4 bg-[#F6FAFC] p-4 border-2 rounded-2xl" style="top:30px;border: 1px solid #c1b8b899;">
                                <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4 my-3">
                                    <div class="col-span-12 md:col-span-3 lg:col-span-3">
                                        <div class="mb-1"><strong class="text-blue">{{ $lang[44] }}</strong></div>
                                        <div>
                                    ...
                                    <div class="col-span-12 md:col-span-3 lg:col-span-3">
                                        <div class="mb-1"><strong class="text-blue">{{ $lang[46] }}</strong></div>
                                        <div>
                                    ...
                                    <div class="col-span-1 md:border-r-2 lg:border-r-2">&nbsp;</div>
                                    <div class="col-span-12 md:col-span-3 lg:col-span-3">
                                        <div class="mb-1"><strong class="text-blue">{{ $lang[47] }}</strong></div>
                                        <div>
                            ...
                            @endif
                            <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4 my-3">
                                <div class="col-span-12 md:col-span-6 lg:col-span-6 border-r-2" >
                                    <p class="ps-3"><strong class="text-blue font-s-20">{{ $lang['10'] }}</strong></p>
                                    <div id="container1" class="mt-3" style="width:100%; height:250px"></div>
                                </div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-6">
                                    <p class="ps-3"><strong class="text-blue font-s-20">MACRO</strong></p>
