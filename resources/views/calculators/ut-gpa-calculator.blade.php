...
<form class="row" action="{{ url()->current() }}/" method="POST">
    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="lg:w-[90%] md:w-[90%] w-full mx-auto ">
                        ...
                        <li style="list-style:none">
                            ...
                            <div class="row addCourse" id="accept_row1">
                                ...
                                <div class="w-full pb-2 mt-3">
                                    <button type="button" title="Add New Course" class="col-6 col-md-4 units_active  border radius-5 cursor-pointer add_course bg-[#2845F5] text-white p-3 rounded-lg">
                                        <strong class="flex items-center  justify-center"><span class="">+</span> <?=$lang['add_course']?></strong>
                                    </button>
                                    <button type="button" title="Add New Semester" class="col-6 col-md-4 units_active  border radius-5 cursor-pointer add_semester bg-[#2845F5] text-white p-3 rounded-lg">
                                        <strong class="flex items-center  justify-center"><span class="">+</span> <?=$lang['add_semester']?></strong>
                                    </button>
                                </div>
                            </div>
                        </li>
            ...
            <div class="w-full text-center mt-1 flex justify-center flex-wrap calculate_reset  my-5">
    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg  space-y-6 result hidden">
        <div class="">
            ...
            <div class="rounded-lg  flex items-center justify-center">
                <div class="w-full">
                    <div class="w-full">
                        <p class="text-center text-blue font-s-18 mt-2"><strong><?=$lang['total_g']?> = <span class="font-s-25 total_g">0.0</span></strong></p>
                        <p class="text-center text-blue border-b pb-2 font-s-18"><strong><?=$lang['total_h']?> = <span class="font-s-25 total_h">0.0</span></strong></p>
                            ...
                            <li class="w-full pb-2 semester1 mt-3" style="list-style:none">
                                ...
                                <div class="w-full overflow-auto mt-2">
                                    <table class="w-full" cellspacing="0" style="border-collapse:collapse">
                                        ...
                                        <tfoot>
                                            <tr class="bg-white">
                                                <td class="p-2 border text-blue" colspan="2"><strong><?=$lang['12']?></strong></td>
                                                <td class="border p-2" colspan="2"><strong class="text-blue hour1">0.0</strong></td>
                                            </tr>
                                            <tr class="bg-white">
                                                <td class="p-2 border text-blue" colspan="2"><strong><?=$lang['10']?></strong></td>
        ...
        var semester='<li style="list-style:none" class="mt-3">'+
            ...
            '<div class="row addCourse mt-2" id="accept_row'+count+'">'+
                ...
                '<div class="col-12 pb-2 mt-3">'+
                    '<button type="button" title="Add New Course" class="col-6 col-md-4 units_active p-2 border radius-5 cursor-pointer text-blue add_course"><strong class="flex items-center  justify-center bg-[#2845F5] p-3 rounded-lg"><span class=" font-s-18 pe-2">+</span> <?=$lang['add_course']?></strong></button>'+
                    '<button type="button" title="Add New Semester" class="col-6 col-md-4 units_active p-2 border radius-5 cursor-pointer text-blue add_semester"><strong class="flex items-center  justify-center bg-[#2845F5] p-3 rounded-lg"><span class=" font-s-18 pe-2">+</span> <?=$lang['add_semester']?></strong></button>'+
                '</div>'+
            '</div>'+
        '</li>';
