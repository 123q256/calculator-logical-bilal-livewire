                ...
                <div class="col-span-12">
                    ...
                    <div class="relative w-full mt-[7px]">
                        ...
                        <div id="angle_unit_dropdown" class="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0 hidden" to="angle_unit">
                            ...
                            <p class="p-2 hover:bg-gray-100 cursor-pointer" onclick="setUnit('angle_unit', 'mrad">milliradian (mrad)</p>
                        ...
                        <div class="w-full md:w-[60%] lg:w-[60%]  mt-2">
                            <table class="w-full font-s-18">
                                @php
                                    ...
                                    $cos=$detail['cos'];
                                    $table=array("0.8660254"=>"{\sqrt 3} \over 2", "0.70710678"=>"{\sqrt 2} \over 2", "0.5"=>"{1\over2}");
                                @endphp
                                @if($_POST['angle_unit']==='deg')
                                    @php
                                        $val='';
                                    ...
                                    @if(!empty($val))
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="py-2 border-b" width="60%"><strong>({{$_POST['angle'].$deg}})</strong></td>
