    ...
    <div class="row mx-auto">
        ...
        <div class="col-lg-7 mx-auto">
            <div class="row align-items-center">
                <strong class="col-lg-3 pe- font-s-14">{{ $lang['to_cal'] ?? "To Calculate" }} :</strong>
                <div class="col-lg-6 d-flex {{$device == 'desktop' ? 'justify-content-around' : 'justify-content-between' }} my-3 velocitytab border-b-dark position-relative">
        ...
        <div class="col-lg-7 px-lg-2 mx-auto">
            ...
            <div class="row document {{$request->main != 2 ? '' : 'd-none'}}">
            ...
            <div class=" books {{$request->main != 2 ? 'd-none' : 'row'}}">
                    ...
                    <div class="py-1">
                        <select class='form-control select2 ' name='lang' id="lang">
                            @php
                                ...
                                "Indonesian", "German", "Japanese", "Swahili", "Marathi", "Telugu", "Wu", "Turkish", "Korean", "Tamil",
                                 "Vietnamese", "Yue Chinese", "Egyptian Arabic", "Gujarati", "Iranian Persian", "Bhojpuri", "Hakka Chinese",
                                "Jin Chinese", "Pashto", "Xiang Chinese", "Malayalam", "Sunda", "Hausa", "Odia", "Burmese", "Punjabi", "Thai",
                                "Gujarati", "Kannada", "Chinese", "Polish", "Yoruba", "Azerbaijani", "Maithili", "Uzbek", "Sinhalese", "Khmer",
                                "Nepali", "Turkmen", "Tagalog", "Assamese", "Madurese", "Somali", "Marwari", "Magahi", "Min Nan Chinese", "Bhojpuri"
                                ];
                                $val = [
                                    "English", "Mandarin", "Hindi", "Spanish", "French", "Arabic", "Bengali", "Russian", "Portuguese", "Urdu",
                                    "Indonesian", "German", "Japanese", "Swahili", "Marathi", "Telugu", "Wu", "Turkish", "Korean", "Tamil",
