...
<form class="row" action="{{ url()->current() }}/" method="POST">
    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mblue
        @if (isset($error)) <p class="text-red-500 text-lg font-semibold w-full">{{ $error }}</p> @endif
       <div class="lg:w-[50%]
        md:w-[50%] w-full mx-auto ">
            ...
            <div class="col-span-12">
                ...
                <div class="w-100 py-2 relative">
                    <input type="text" name="EnterEq" id="EnterEq" class="input" value="{{ isset($request->EnterEq) ? $request->EnterEq : '(5x^5-3x)(3x^{7}+2)' }}" aria-label="input"/>
            ...
            <div class="col-span-12 hidden keyboard">
               ...
               <div class="col-span-12">
                <label for="with" class="font-s-14 text-blue"><?= $lang['3'] ?> W.R.T:</label>
                            ...
                            <div class="w-full text-[16px]">
                                @if ($how > 1)
                                    ...
                                    @for ($i = 1; $i < count($detail['final_res']); $i++)
                                        <p class="mt-3 text-[18px]"><strong>\( f{{ $j }} (x)\)
                                                {{ $lang['3'] }}</strong></p>
                                        ...
                                        <div class="w-full mt-3 res_step d-none" step_cal="{{ $i }}">
            ...
            <script>
                function loadMathJax() {
                    ...
                    mathJaxConfigScript.textContent =
                        'MathJax.Hub.Config({"HTML-CSS": {linebreaks: { automatic: true }},"CommonHTML": {linebreaks: { automatic: true }}}); function MJrerender() { MathJax.Hub.Queue(["Rerender", MathJax.Hub]); }';
