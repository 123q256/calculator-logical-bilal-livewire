        ...
        <div class="lg:w-[80%] md:w-[80%] w-full mx-auto ">
            <div class="grid grid-cols-1 gap-4">
                <div class="space-y-2 relative">
                    <button type="button" class="bg-[#2845F5] shadow-2xl text-[#fff]  hover:text-white duration-200 font-[600] text-[16px] rounded px-5 py-3" id="load_example">{!! $lang['2'] !!}</button>
                </div>
            </div>
            <div class="grid grid-cols-1 mt-4 gap-4">
                <div class="space-y-2 relative">
                    <label for="eq" class="text-[14px] text-blue">{!! $lang['1'] !!}:</label>
            ...
            <div class="w-full overflow-auto px-2 mt-5">
                ...
                <table class="w-full text-center t_set" cellpadding="7">
                    <tbody>
                    <tr>
                        <td id="spc" class="text-white radius-20 bg-[#2845F5]">{{ $lang['5'] }}</td>
                        ...
                        <td class="check t6">=</td>
                        <td id="clr" class="text-white radius-20 bg-[#2845F5]">{{ $lang['6'] }}</td>
                    </tr>
                    </tbody>
                </table>
                </div>
            ...
            <div class="rounded-lg  flex items-center justify-center">
                <div class="w-full mt-3">
                    <div class="w-full">
                        ...
                        <div class='result overflow-auto' id='resid'>
                            ...
                            <div class='table mt-3 overflow-auto'>
                                <table id='tabledata' class="w-full" cellspacing="0"></table>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('calculatorJS')
        ...
        <script>
            ...
            @if(isset($detail))
                ...
                val += "<tr><th class='border-b p-2'>{!! $lang['6'] !!}</th> <th class='border-b p-2'>{!! $lang['7'] !!}</th> <th class='border-b p-2'>{!! $lang['8'] !!}</th> <th class='border-b p-2'>{!! $lang['9'] !!}(g/mol)</th>  <th class='border-b p-2'>{!! $lang['10'] !!}(g)</th> </tr> ";
                val += " <tr><th class='border-b p-2' colspan=5>{!! $lang['11'] !!}</th></tr>";
                for(i=1;i<=rlen;i++){
                    val+="<tr><td class='border-b p-2'>"+reactant[i-1]+"</td> <td class='border-b p-2'>"+reactratio[i-1] +"</td> <td class='border-b p-2'>"+reactarr[i-1]+"</td> <td class='border-b p-2'> <input type=text class='input' id=mr"+i+" value='' onkeyup='calc(this)'></td> <td class='border-b p-2'> <input type=text class='input' id=wr"+i+" value='' onkeyup='calc(this)'></td></tr>";
                }
                ...
                $(".table").append("<div class='col-lg-4 p-2 mx-auto'><input class='input fw-bold' id='opp' val='' type='text' readonly></div>");
                var rwt = [];
                var rml = [];
