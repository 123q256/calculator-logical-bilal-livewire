<!-- <p>chlll poo</p> -->
<p class="mt-2"><b><?=$lang[24]?> <?=$action1?> <?=$lang[25]?></b></p>
<?php if($action1=='÷'){ 
    $ON3 = $N3;
    $OD3 = $D3;
    $N3 = $OD3;
...
<!-- <?php echo('chlo') ?> -->
<p class="text-center mt-2">
    \( \dfrac{<?=$N2?>\times<?=$N3?>}{<?=$D2?>\times<?=$D3?>} = \dfrac{<?=$N3*$N2?>}{<?=$D3*$D2?>} \)
</p>
<?php $up = $N3*$N2;$btm=$D3*$D2 ?>
<?php if(gcd($up,$btm)!=1){ $gcd=gcd($up,$btm); ?>
    <p class="mt-2"><?=$lang[18]?> <?=$up?> and <?=$btm?> using</p>
    <p class="mt-2">
...
<p class="mt-2"><b><?=$lang[29]?> <?=$action?> <?=$lang[25]?></b></p>
<?php 
    $n2 = $N2;$d2=$D2;
    $n1 = $N1;$d1=$D1;
    $n3 = $N3;$d3=$D3;
...
<?php if($detail['btm']!=1 && $detail['upr']!=0 && $detail['upr']>$detail['btm']){ ?>
    ...
    <?php if($detail['upr']%$detail['btm']!=0 && $detail['upr']>$detail['btm']){ ?>
        ...
        <p class="mt-2"><?=$lang[23]?>:</p>
        <p class="text-center mt-2">\( \dfrac{<?=$n1?>}{<?=$d1?>} <?=$act?> \dfrac{<?=$n2?>}{<?=$d2?>} <?=$act1?> \dfrac{<?=$d3?>}{<?=$n3?>} = <?=$shi.' \\dfrac{'.$bta.'}{'.$detail['btm']?>} \)</p>
    <?php } ?>
<?php }else{ ?>
        <p class="mt-2"><?=$lang[23]?>:</p>
        <p class="text-center mt-2">
