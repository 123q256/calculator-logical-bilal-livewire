       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-6 md:col-span-3 lg:col-span-3  ft_in">
                    ...
                    <div class="relative w-full mt-[7px]">
                        <input type="number" name="height-in" id="height-in" step="any"  class="border border-gray-300 p-2 rounded-lg focus:ring-2  w-full" value="{{ isset($_POST['height-in']) ? $_POST['height-in'] : '' }}" aria-label="input" placeholder="00" oninput="checkInput()"/>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6 hidden h_cm">
                    ...
                    <div class="relative w-full mt-[7px]">
                        <input type="number" name="height-cm" id="height-cm" step="any"  class="border border-gray-300 p-2 rounded-lg focus:ring-2  w-full" value="{{ isset($_POST['height-cm']) ? $_POST['height-cm'] : '' }}" aria-label="input" placeholder="00" oninput="checkInput()"/>
