       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div class="col-span-12 text-center flex justify-center">
                    <img src="{{asset('images/cot_prop.svg')}}" height="100%" width="70%" alt="tangent Graph" style="object-fit: contain;" loading="lazy" decoding="async">
                </div>
        </div>
                        ...
                        <div class="w-full md:w-[60%] lg:w-[60%]  mt-2">
                            <table class="w-full text-[18px]">
                                ...
                                @if($_POST['angle_unit']==='deg')
                                    ...
                                    @if(!empty($val))
                                        <tr>
                                            <td class="py-2 border-b" width="60%"><strong>cot({{$_POST['angle'].$deg}})</strong></td>
