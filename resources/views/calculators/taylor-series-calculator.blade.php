    ...
    <div class="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 my-3">
       ...
       <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            ...
            <div class="col-span-6">
                ...
                <div class="w-full py-2">
                    <input type="number" name="point" id="point" class="input" value="{{ isset($request->point)?$request->point:'1' }}" aria-label="input"/>
                </div>
            </div>
            <div class="col-span-6">
                <label for="n" class="label">{{$lang['4']}} n:</label>
                <div class="w-full py-2">
                    <input type="number" name="n" id="n" max="10" class="input" value="{{ isset($request->n)?$request->n:'4' }}" aria-label="input"/>
                </div>
            </div>
