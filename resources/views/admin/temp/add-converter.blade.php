...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
	<div class="row">
		<h1 class="col-sm-12 h3">Add New Converter</h1>
		<div class="col-sm-12">
            ...
            @endif
			<form method="POST" action="{{ url('admin/add-converter') }}/" accept-charset="UTF-8" enctype="multipart/form-data">
				...
				<div class="col-md-6 col-md-12">
					<div class="form-group">
						...
						<select class="form-control" required name="cal_cat" id="cat_cal">
							<option selected disabled>Select Converter Category</option>
                            <option value="common-converters">Common Converters</option>
                            <option value="engineering-converters">Engineering Converters</option>
                            <option value="electricity-converters">Electricity Converters</option>
                            <option value="heat-converters">Heat Converters</option>
                            <option value="magnetism-converters">Magnetism Converters</option>
                            <option value="fluids-converters">Fluids Converters</option>
                            <option value="radiology-converters">Radiology Converters</option>
                            <option value="light-converters">Light Converters</option>
                            <option value="other-converters">Other Converters</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group mb-5 mt-5">
			            <input type="submit" name="add_calculator" class="btn btn-primary" value="Add Converter">
			        </div>
			    </div>
				<div class="col-md-6 col-md-12">
