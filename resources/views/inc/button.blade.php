<div class="flex justify-center gap-3 mb-6 mt-10">
    <button type="submit" id="calculate" wire:loading.attr="disabled"
        class="relative bg-gradient-to-r from-blue-700 to-blue-500 shadow-2xl text-[#fff] hover:bg-[#1A1A1A] hover:text-white duration-200 font-[600] text-[16px] rounded-[10px] px-5 py-3 flex items-center justify-center gap-2">
