...
@if (isset($og) && file_exists(public_path($og)))
    ...
    <meta property="og:site_name" content="Logical Calculator" />
    ...
    <meta name="twitter:site" content="@Logical-calculator.com " />
    ...
    <link rel="canonical" href="{{ url()->current() }}" />
     <meta property="og:site_name" content="Logical Calculator" />
        ...
        <meta property="og:image" content="<?=url('images/ogview/ogy/calculator.png')?>" />
        <meta property="og:url" content="<?=url()->current()?>" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@Logical-calculator.com " />
        <meta name="twitter:title" content="<?= $meta_title ?? '' ?>" />
        <meta name="twitter:description" content="<?=$meta_des ?? '' ?>">
        <meta name="twitter:image" content="<?=url('images/ogview/ogy/calculator.png')?>">
    @endif