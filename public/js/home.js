/**
 * home.js - jQuery-based calculator search
 * Replaces the Livewire search.calculator-search component
 */

$(function () {

    var $input       = $('#hero-search-input');
    var $dropdown    = $('#hero-search-dropdown');
    var $list        = $('#hero-search-list');
    var currentFocus = -1;
    var filteredData = [];

    /* ----------------------------------------------------------
     * Build suggestion HTML for one item
     * ---------------------------------------------------------- */
     ...
     * ---------------------------------------------------------- */
    $('#hero-search-icon').on('click', function () {
        $input.trigger('focus');
    });
